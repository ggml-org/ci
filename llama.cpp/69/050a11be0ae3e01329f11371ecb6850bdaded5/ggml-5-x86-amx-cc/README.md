...
- status:  SUCCESS ✅
- runtime: 4:27.49
- date:    Wed Feb 26 13:09:38 UTC 2025
...
0.00.000.280 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.820 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.007.828 I print_info: file size   = 63.84 MiB (16.12 BPW) 
...
0.00.021.481 I print_info: n_head           = 12
0.00.021.482 I print_info: n_head_kv        = 12
0.00.021.482 I print_info: n_rot            = 32
0.00.021.483 I print_info: n_swa            = 0
0.00.021.483 I print_info: n_embd_head_k    = 32
0.00.021.483 I print_info: n_embd_head_v    = 32
0.00.021.485 I print_info: n_gqa            = 1
0.00.021.486 I print_info: n_embd_k_gqa     = 384
0.00.021.487 I print_info: n_embd_v_gqa     = 384
0.00.021.490 I print_info: f_norm_eps       = 1.0e-12
0.00.021.490 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.021.491 I print_info: f_clamp_kqv      = 0.0e+00
0.00.021.491 I print_info: f_max_alibi_bias = 0.0e+00
0.00.021.492 I print_info: f_logit_scale    = 0.0e+00
0.00.021.493 I print_info: n_ff             = 1536
0.00.021.493 I print_info: n_expert         = 0
0.00.021.494 I print_info: n_expert_used    = 0
0.00.021.494 I print_info: causal attn      = 0
0.00.021.494 I print_info: pooling type     = 2
0.00.021.494 I print_info: rope type        = 2
0.00.021.495 I print_info: rope scaling     = linear
...
0.00.021.497 I print_info: ssm_d_conv       = 0
0.00.021.498 I print_info: ssm_d_inner      = 0
0.00.021.498 I print_info: ssm_d_state      = 0
0.00.021.498 I print_info: ssm_dt_rank      = 0
0.00.021.498 I print_info: ssm_dt_b_c_rms   = 0
0.00.021.498 I print_info: model type       = 33M
0.00.021.499 I print_info: model params     = 33.21 M
0.00.021.500 I print_info: general.name     = Bge Small
0.00.021.502 I print_info: vocab type       = WPM
0.00.021.504 I print_info: n_vocab          = 30522
0.00.021.504 I print_info: n_merges         = 0
...
...............................................
0.00.040.124 I llama_init_from_model: n_seq_max     = 1
0.00.040.139 I llama_init_from_model: n_ctx         = 512
0.00.040.139 I llama_init_from_model: n_ctx_per_seq = 512
0.00.040.140 I llama_init_from_model: n_batch       = 2048
0.00.040.140 I llama_init_from_model: n_ubatch      = 2048
0.00.040.140 I llama_init_from_model: flash_attn    = 0
0.00.040.154 I llama_init_from_model: freq_base     = 10000.0
0.00.040.155 I llama_init_from_model: freq_scale    = 1
0.00.040.180 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.042.171 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.042.196 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.042.203 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.044.869 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.044.885 I llama_init_from_model: graph nodes  = 429
0.00.044.885 I llama_init_from_model: graph splits = 1
0.00.044.889 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.044.889 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.048.401 I 
0.00.048.486 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.049.863 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.054.217 I llama_perf_context_print:        load time =      48.08 ms
0.00.054.219 I llama_perf_context_print: prompt eval time =       4.09 ms /     9 tokens (    0.45 ms per token,  2198.34 tokens per second)
0.00.054.220 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.054.221 I llama_perf_context_print:       total time =       5.82 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.266 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.954 I print_info: n_ctx_train      = 512
...
0.00.021.971 I print_info: f_max_alibi_bias = 0.0e+00
0.00.021.972 I print_info: f_logit_scale    = 0.0e+00
0.00.021.974 I print_info: n_ff             = 1536
0.00.021.974 I print_info: n_expert         = 0
0.00.021.974 I print_info: n_expert_used    = 0
0.00.021.975 I print_info: causal attn      = 0
...
0.00.021.983 I print_info: n_vocab          = 30522
...
0.00.021.986 I print_info: MASK token       = 103 '[MASK]'
...
0.00.024.911 I load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.031.090 I llama_init_from_model: n_seq_max     = 1
0.00.031.104 I llama_init_from_model: n_ctx         = 512
0.00.031.105 I llama_init_from_model: n_ctx_per_seq = 512
0.00.031.106 I llama_init_from_model: n_batch       = 2048
0.00.031.106 I llama_init_from_model: n_ubatch      = 2048
0.00.031.107 I llama_init_from_model: flash_attn    = 0
0.00.031.109 I llama_init_from_model: freq_base     = 10000.0
0.00.031.111 I llama_init_from_model: freq_scale    = 1
0.00.031.126 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.033.200 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.033.229 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.033.236 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.035.763 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.035.776 I llama_init_from_model: graph nodes  = 429
0.00.035.776 I llama_init_from_model: graph splits = 1
0.00.035.780 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.035.780 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.083 I 
0.00.038.170 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.039.155 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.041.775 I llama_perf_context_print:        load time =      37.78 ms
0.00.041.777 I llama_perf_context_print: prompt eval time =       2.14 ms /     9 tokens (    0.24 ms per token,  4207.57 tokens per second)
0.00.041.778 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.041.778 I llama_perf_context_print:       total time =       3.69 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.273 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.009.479 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
...
0.00.019.530 I llama_model_loader: - kv  24:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.531 I llama_model_loader: - kv  25:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.532 I llama_model_loader: - kv  26:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.532 I llama_model_loader: - kv  27:               general.quantization_version u32              = 2
0.00.019.535 I llama_model_loader: - type  f32:   40 tensors
0.00.019.535 I llama_model_loader: - type  f16:   30 tensors
0.00.019.537 I print_info: file format = GGUF V3 (latest)
0.00.019.538 I print_info: file type   = F16
0.00.019.540 I print_info: file size   = 62.78 MiB (16.01 BPW) 
...
0.00.050.989 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.051.140 I load: special tokens cache size = 5
0.00.341.410 I load: token to piece cache size = 1.5060 MB
0.00.341.433 I print_info: arch             = jina-bert-v2
0.00.341.433 I print_info: vocab_only       = 0
0.00.341.434 I print_info: n_ctx_train      = 8192
0.00.341.434 I print_info: n_embd           = 384
0.00.341.434 I print_info: n_layer          = 4
0.00.341.442 I print_info: n_head           = 12
0.00.341.444 I print_info: n_head_kv        = 12
0.00.341.444 I print_info: n_rot            = 32
0.00.341.444 I print_info: n_swa            = 0
0.00.341.445 I print_info: n_embd_head_k    = 32
0.00.341.445 I print_info: n_embd_head_v    = 32
0.00.341.446 I print_info: n_gqa            = 1
0.00.341.448 I print_info: n_embd_k_gqa     = 384
0.00.341.449 I print_info: n_embd_v_gqa     = 384
0.00.341.450 I print_info: f_norm_eps       = 1.0e-12
0.00.341.451 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.341.451 I print_info: f_clamp_kqv      = 0.0e+00
0.00.341.452 I print_info: f_max_alibi_bias = 8.0e+00
0.00.341.452 I print_info: f_logit_scale    = 0.0e+00
0.00.341.454 I print_info: n_ff             = 1536
0.00.341.454 I print_info: n_expert         = 0
0.00.341.454 I print_info: n_expert_used    = 0
0.00.341.455 I print_info: causal attn      = 0
0.00.341.455 I print_info: pooling type     = -1
0.00.341.456 I print_info: rope type        = -1
0.00.341.456 I print_info: rope scaling     = linear
0.00.341.457 I print_info: freq_base_train  = 10000.0
0.00.341.458 I print_info: freq_scale_train = 1
0.00.341.458 I print_info: n_ctx_orig_yarn  = 8192
0.00.341.458 I print_info: rope_finetuned   = unknown
0.00.341.459 I print_info: ssm_d_conv       = 0
0.00.341.459 I print_info: ssm_d_inner      = 0
0.00.341.459 I print_info: ssm_d_state      = 0
0.00.341.459 I print_info: ssm_dt_rank      = 0
0.00.341.460 I print_info: ssm_dt_b_c_rms   = 0
0.00.341.460 I print_info: model type       = 33M
0.00.341.461 I print_info: model params     = 32.90 M
0.00.341.462 I print_info: general.name     = Jina Bert Implementation
0.00.341.464 I print_info: vocab type       = BPE
0.00.341.465 I print_info: n_vocab          = 61056
0.00.341.465 I print_info: n_merges         = 39382
0.00.341.466 I print_info: BOS token        = 0 '<s>'
0.00.341.466 I print_info: EOS token        = 2 '</s>'
0.00.341.466 I print_info: UNK token        = 3 '<unk>'
0.00.341.467 I print_info: SEP token        = 2 '</s>'
0.00.341.467 I print_info: PAD token        = 1 '<pad>'
0.00.341.467 I print_info: MASK token       = 4 '<mask>'
0.00.341.468 I print_info: EOG token        = 2 '</s>'
0.00.341.468 I print_info: max token length = 45
0.00.341.469 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.346.022 I load_tensors:          AMX model buffer size =    18.00 MiB
0.00.346.044 I load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.351.937 I llama_init_from_model: n_seq_max     = 1
0.00.351.956 I llama_init_from_model: n_ctx         = 8192
0.00.351.956 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.351.956 I llama_init_from_model: n_batch       = 2048
0.00.351.956 I llama_init_from_model: n_ubatch      = 2048
0.00.351.957 I llama_init_from_model: flash_attn    = 0
0.00.351.959 I llama_init_from_model: freq_base     = 10000.0
...
0.00.360.941 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.360.967 I llama_init_from_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.360.975 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.363.084 I llama_init_from_model:        CPU compute buffer size =   220.02 MiB
0.00.363.104 I llama_init_from_model: graph nodes  = 154
0.00.363.105 I llama_init_from_model: graph splits = 1
0.00.363.109 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.363.110 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.382 I 
0.00.371.458 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.614 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.627 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.632 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.632 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.637 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.637 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.561 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.060 I llama_perf_context_print:        load time =     371.01 ms
0.00.383.062 I llama_perf_context_print: prompt eval time =       7.31 ms /    62 tokens (    0.12 ms per token,  8482.69 tokens per second)
0.00.383.063 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.064 I llama_perf_context_print:       total time =      11.68 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.259 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.506 I main: llama backend init
0.00.000.523 I main: load the model and apply lora adapter, if any
0.00.011.594 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.011.616 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.011.625 I llama_model_loader: - kv   0:                       general.architecture str              = gptneox
0.00.011.626 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.011.627 I llama_model_loader: - kv   2:                               general.name str              = 1.4B
0.00.011.627 I llama_model_loader: - kv   3:                           general.finetune str              = 1.4B
0.00.011.628 I llama_model_loader: - kv   4:                         general.size_label str              = 1.4B
0.00.011.633 I llama_model_loader: - kv   5:                     gptneox.context_length u32              = 2048
0.00.011.633 I llama_model_loader: - kv   6:                   gptneox.embedding_length u32              = 2048
0.00.011.634 I llama_model_loader: - kv   7:                        gptneox.block_count u32              = 24
0.00.011.634 I llama_model_loader: - kv   8:                gptneox.feed_forward_length u32              = 8192
0.00.011.635 I llama_model_loader: - kv   9:               gptneox.rope.dimension_count u32              = 32
0.00.011.635 I llama_model_loader: - kv  10:               gptneox.attention.head_count u32              = 16
0.00.011.636 I llama_model_loader: - kv  11:              gptneox.use_parallel_residual bool             = true
0.00.011.648 I llama_model_loader: - kv  12:       gptneox.attention.layer_norm_epsilon f32              = 0.000010
0.00.011.648 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.011.649 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = olmo
...
0.00.065.043 I print_info: n_head           = 16
0.00.065.044 I print_info: n_head_kv        = 16
0.00.065.045 I print_info: n_rot            = 32
0.00.065.045 I print_info: n_swa            = 0
0.00.065.045 I print_info: n_embd_head_k    = 128
0.00.065.045 I print_info: n_embd_head_v    = 128
0.00.065.047 I print_info: n_gqa            = 1
0.00.065.048 I print_info: n_embd_k_gqa     = 2048
0.00.065.050 I print_info: n_embd_v_gqa     = 2048
0.00.065.051 I print_info: f_norm_eps       = 1.0e-05
0.00.065.051 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.065.052 I print_info: f_clamp_kqv      = 0.0e+00
...
0.00.065.053 I print_info: n_expert         = 0
0.00.065.054 I print_info: n_expert_used    = 0
0.00.065.054 I print_info: causal attn      = 1
0.00.065.054 I print_info: pooling type     = 0
...
0.00.065.058 I print_info: ssm_dt_rank      = 0
...
0.00.065.062 I print_info: vocab type       = BPE
...
0.00.201.173 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.201.195 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.034.923 I llama_init_from_model: n_seq_max     = 1
0.01.034.942 I llama_init_from_model: n_ctx         = 2048
0.01.034.943 I llama_init_from_model: n_ctx_per_seq = 2048
0.01.034.943 I llama_init_from_model: n_batch       = 2048
0.01.034.943 I llama_init_from_model: n_ubatch      = 512
0.01.034.944 I llama_init_from_model: flash_attn    = 0
0.01.034.949 I llama_init_from_model: freq_base     = 10000.0
0.01.034.950 I llama_init_from_model: freq_scale    = 1
0.01.034.979 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.122.493 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.122.524 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.122.560 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.126.950 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.01.126.967 I llama_init_from_model: graph nodes  = 967
0.01.126.968 I llama_init_from_model: graph splits = 1
0.01.126.980 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.01.127.294 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.01.127.306 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.249.855 I main: llama threadpool init, n_threads = 4
0.01.249.879 I 
0.01.249.952 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.249.965 I 
0.01.250.056 I sampler seed: 1234
0.01.250.075 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.250.078 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.250.079 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.250.079 I 
...
0.05.281.645 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27466.15 tokens per second)
0.05.281.649 I llama_perf_context_print:        load time =    1248.22 ms
0.05.281.651 I llama_perf_context_print: prompt eval time =     101.96 ms /     7 tokens (   14.57 ms per token,    68.65 tokens per second)
0.05.281.652 I llama_perf_context_print:        eval time =    3916.90 ms /    63 runs   (   62.17 ms per token,    16.08 tokens per second)
0.05.281.653 I llama_perf_context_print:       total time =    4032.88 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.338 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.203.732 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.203.752 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.038.996 I llama_init_from_model: n_seq_max     = 1
0.01.039.015 I llama_init_from_model: n_ctx         = 128
0.01.039.016 I llama_init_from_model: n_ctx_per_seq = 128
0.01.039.016 I llama_init_from_model: n_batch       = 128
0.01.039.016 I llama_init_from_model: n_ubatch      = 128
0.01.039.017 I llama_init_from_model: flash_attn    = 0
0.01.039.021 I llama_init_from_model: freq_base     = 10000.0
0.01.039.022 I llama_init_from_model: freq_scale    = 1
0.01.039.023 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.039.064 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.043.607 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.043.637 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.043.669 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.046.875 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.01.046.892 I llama_init_from_model: graph nodes  = 967
0.01.046.892 I llama_init_from_model: graph splits = 1
0.01.046.897 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.01.046.897 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.117.389 I 
0.01.117.520 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.117.542 I perplexity: tokenizing the input ..
0.01.124.058 I perplexity: tokenization took 6.513 ms
0.01.124.094 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.154.199 I perplexity: 1.03 seconds per pass - ETA 0.02 minutes
[1]10.1485,
0.02.158.088 I Final estimate: PPL = 10.1485 +/- 3.22644

0.02.158.137 I llama_perf_context_print:        load time =    1116.91 ms
0.02.158.152 I llama_perf_context_print: prompt eval time =    1028.22 ms /   128 tokens (    8.03 ms per token,   124.49 tokens per second)
0.02.158.153 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.158.154 I llama_perf_context_print:       total time =    1040.80 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.322 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.096 I print_info: file type   = Q8_0
0.00.021.099 I print_info: file size   = 1.40 GiB (8.51 BPW) 
...
0.00.157.743 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.157.764 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.318.437 I llama_init_from_model: n_seq_max     = 1
0.00.318.469 I llama_init_from_model: n_ctx         = 2048
0.00.318.476 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.318.483 I llama_init_from_model: n_batch       = 2048
0.00.318.490 I llama_init_from_model: n_ubatch      = 512
0.00.318.497 I llama_init_from_model: flash_attn    = 0
0.00.318.508 I llama_init_from_model: freq_base     = 10000.0
0.00.318.518 I llama_init_from_model: freq_scale    = 1
0.00.318.551 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.390.537 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.390.584 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.390.626 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.393.961 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.393.996 I llama_init_from_model: graph nodes  = 967
0.00.394.003 I llama_init_from_model: graph splits = 1
0.00.394.021 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.394.369 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.394.390 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.492.498 I main: llama threadpool init, n_threads = 4
0.00.492.520 I 
0.00.492.598 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.492.651 I 
0.00.492.760 I sampler seed: 1234
0.00.492.779 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.492.783 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.492.784 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.492.784 I 
I believe the meaning of life is to die, not live." "We're all going to die." "We all are." "We're all going to die." "The answer is no." "I can't do it." "What?" "I can't do it." "What?" "The answer is no." "No!" "It

0.02.746.139 I llama_perf_sampler_print:    sampling time =       2.44 ms /    71 runs   (    0.03 ms per token, 29122.23 tokens per second)
0.02.746.142 I llama_perf_context_print:        load time =     490.83 ms
0.02.746.143 I llama_perf_context_print: prompt eval time =      50.04 ms /     7 tokens (    7.15 ms per token,   139.88 tokens per second)
0.02.746.144 I llama_perf_context_print:        eval time =    2191.03 ms /    63 runs   (   34.78 ms per token,    28.75 tokens per second)
0.02.746.145 I llama_perf_context_print:       total time =    2254.77 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.369 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.160.250 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.160.271 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.321.460 I llama_init_from_model: n_seq_max     = 1
0.00.321.488 I llama_init_from_model: n_ctx         = 128
0.00.321.495 I llama_init_from_model: n_ctx_per_seq = 128
0.00.321.502 I llama_init_from_model: n_batch       = 128
0.00.321.509 I llama_init_from_model: n_ubatch      = 128
0.00.321.516 I llama_init_from_model: flash_attn    = 0
0.00.321.527 I llama_init_from_model: freq_base     = 10000.0
0.00.321.547 I llama_init_from_model: freq_scale    = 1
0.00.321.554 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.321.588 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.326.568 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.326.611 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.326.653 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.330.143 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.330.179 I llama_init_from_model: graph nodes  = 967
0.00.330.185 I llama_init_from_model: graph splits = 1
0.00.330.197 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.330.203 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.387.873 I 
0.00.387.998 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.388.023 I perplexity: tokenizing the input ..
0.00.394.525 I perplexity: tokenization took 6.497 ms
0.00.394.555 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.789.237 I perplexity: 0.39 seconds per pass - ETA 0.00 minutes
[1]10.1611,
0.00.793.013 I Final estimate: PPL = 10.1611 +/- 3.23215

0.00.793.055 I llama_perf_context_print:        load time =     387.45 ms
0.00.793.068 I llama_perf_context_print: prompt eval time =     392.72 ms /   128 tokens (    3.07 ms per token,   325.94 tokens per second)
0.00.793.069 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.793.070 I llama_perf_context_print:       total time =     405.18 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.253 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.183 I print_info: file size   = 786.31 MiB (4.66 BPW) 
...
0.00.117.048 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.117.069 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.227.144 I llama_init_from_model: n_seq_max     = 1
0.00.227.176 I llama_init_from_model: n_ctx         = 2048
0.00.227.183 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.227.190 I llama_init_from_model: n_batch       = 2048
0.00.227.196 I llama_init_from_model: n_ubatch      = 512
0.00.227.203 I llama_init_from_model: flash_attn    = 0
0.00.227.214 I llama_init_from_model: freq_base     = 10000.0
0.00.227.224 I llama_init_from_model: freq_scale    = 1
0.00.227.257 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.301.540 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.301.589 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.301.631 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.305.046 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.305.077 I llama_init_from_model: graph nodes  = 967
0.00.305.084 I llama_init_from_model: graph splits = 1
0.00.305.103 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.305.417 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.305.437 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.389.551 I main: llama threadpool init, n_threads = 4
0.00.389.574 I 
0.00.389.649 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.389.649 I 
0.00.389.778 I sampler seed: 1234
0.00.389.785 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.389.788 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.389.788 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.389.789 I 
I believe the meaning of life is to know and experience what you love and to do it." "If you love something, set it free." "You might just find something you didn't know you wanted." "I've always wanted to know the truth." "Now I have." "So I'm gonna get to the truth." "I'm gonna

0.01.896.022 I llama_perf_sampler_print:    sampling time =       2.42 ms /    71 runs   (    0.03 ms per token, 29375.26 tokens per second)
0.01.896.025 I llama_perf_context_print:        load time =     388.00 ms
0.01.896.026 I llama_perf_context_print: prompt eval time =      49.15 ms /     7 tokens (    7.02 ms per token,   142.42 tokens per second)
0.01.896.027 I llama_perf_context_print:        eval time =    1445.15 ms /    63 runs   (   22.94 ms per token,    43.59 tokens per second)
0.01.896.028 I llama_perf_context_print:       total time =    1507.55 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.312 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.201 I print_info: BOS token        = 0 '<|endoftext|>'
...
0.00.231.258 I llama_init_from_model: n_ctx         = 128
0.00.231.266 I llama_init_from_model: n_ctx_per_seq = 128
0.00.231.272 I llama_init_from_model: n_batch       = 128
0.00.231.279 I llama_init_from_model: n_ubatch      = 128
0.00.231.285 I llama_init_from_model: flash_attn    = 0
0.00.231.310 I llama_init_from_model: freq_base     = 10000.0
0.00.231.318 I llama_init_from_model: freq_scale    = 1
0.00.231.325 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.231.368 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.236.116 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.236.158 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.236.196 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.239.585 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.239.619 I llama_init_from_model: graph nodes  = 967
0.00.239.626 I llama_init_from_model: graph splits = 1
0.00.239.637 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.239.644 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.284.305 I 
0.00.284.416 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.284.437 I perplexity: tokenizing the input ..
0.00.291.073 I perplexity: tokenization took 6.632 ms
0.00.291.105 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.735.566 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]14.1117,
0.00.739.413 I Final estimate: PPL = 14.1117 +/- 4.42919

0.00.739.474 I llama_perf_context_print:        load time =     283.95 ms
0.00.739.476 I llama_perf_context_print: prompt eval time =     442.59 ms /   128 tokens (    3.46 ms per token,   289.21 tokens per second)
0.00.739.478 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.739.479 I llama_perf_context_print:       total time =     455.17 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.294 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.522 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.064.688 I print_info: n_embd_k_gqa     = 2048
0.00.064.689 I print_info: n_embd_v_gqa     = 2048
...
0.00.064.692 I print_info: f_max_alibi_bias = 0.0e+00
0.00.064.692 I print_info: f_logit_scale    = 0.0e+00
0.00.064.693 I print_info: n_ff             = 8192
0.00.064.693 I print_info: n_expert         = 0
0.00.064.693 I print_info: n_expert_used    = 0
0.00.064.694 I print_info: causal attn      = 1
0.00.064.694 I print_info: pooling type     = 0
0.00.064.694 I print_info: rope type        = 2
0.00.064.694 I print_info: rope scaling     = linear
0.00.064.696 I print_info: freq_base_train  = 10000.0
0.00.064.696 I print_info: freq_scale_train = 1
0.00.064.696 I print_info: n_ctx_orig_yarn  = 2048
0.00.064.697 I print_info: rope_finetuned   = unknown
0.00.064.697 I print_info: ssm_d_conv       = 0
0.00.064.697 I print_info: ssm_d_inner      = 0
0.00.064.697 I print_info: ssm_d_state      = 0
0.00.064.697 I print_info: ssm_dt_rank      = 0
0.00.064.698 I print_info: ssm_dt_b_c_rms   = 0
0.00.064.698 I print_info: model type       = 1.4B
0.00.064.699 I print_info: model params     = 1.41 B
0.00.064.699 I print_info: general.name     = 1.4B
...
0.00.121.199 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.121.223 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.243.732 I llama_init_from_model: n_seq_max     = 1
0.00.243.764 I llama_init_from_model: n_ctx         = 2048
0.00.243.771 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.243.778 I llama_init_from_model: n_batch       = 2048
0.00.243.785 I llama_init_from_model: n_ubatch      = 512
0.00.243.793 I llama_init_from_model: flash_attn    = 0
0.00.243.809 I llama_init_from_model: freq_base     = 10000.0
0.00.243.818 I llama_init_from_model: freq_scale    = 1
0.00.243.858 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.317.914 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.317.948 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.317.992 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.321.493 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.321.510 I llama_init_from_model: graph nodes  = 967
0.00.321.511 I llama_init_from_model: graph splits = 1
0.00.321.524 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.321.838 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.321.851 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.397.551 I main: llama threadpool init, n_threads = 4
0.00.397.572 I 
0.00.397.654 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.397.668 I 
...
0.00.397.807 I sampler params: 
	...
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.397.811 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.397.812 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.397.814 I 
...
0.02.034.115 I llama_perf_sampler_print:    sampling time =       2.43 ms /    71 runs   (    0.03 ms per token, 29278.35 tokens per second)
0.02.034.119 I llama_perf_context_print:        load time =     395.86 ms
0.02.034.121 I llama_perf_context_print: prompt eval time =      46.00 ms /     7 tokens (    6.57 ms per token,   152.17 tokens per second)
0.02.034.122 I llama_perf_context_print:        eval time =    1578.18 ms /    63 runs   (   25.05 ms per token,    39.92 tokens per second)
0.02.034.123 I llama_perf_context_print:       total time =    1637.66 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.384 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.120.322 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.120.338 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.243.161 I llama_init_from_model: n_seq_max     = 1
0.00.243.180 I llama_init_from_model: n_ctx         = 128
0.00.243.180 I llama_init_from_model: n_ctx_per_seq = 128
0.00.243.181 I llama_init_from_model: n_batch       = 128
0.00.243.181 I llama_init_from_model: n_ubatch      = 128
0.00.243.182 I llama_init_from_model: flash_attn    = 0
0.00.243.186 I llama_init_from_model: freq_base     = 10000.0
0.00.243.187 I llama_init_from_model: freq_scale    = 1
0.00.243.188 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.243.223 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.247.874 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.247.905 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.247.938 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.251.343 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.251.357 I llama_init_from_model: graph nodes  = 967
0.00.251.358 I llama_init_from_model: graph splits = 1
0.00.251.362 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.251.363 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.296.085 I 
0.00.296.225 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.296.247 I perplexity: tokenizing the input ..
0.00.302.806 I perplexity: tokenization took 6.556 ms
0.00.302.840 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.760.465 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]12.6944,
0.00.764.375 I Final estimate: PPL = 12.6944 +/- 3.90928

0.00.764.423 I llama_perf_context_print:        load time =     295.66 ms
0.00.764.449 I llama_perf_context_print: prompt eval time =     455.69 ms /   128 tokens (    3.56 ms per token,   280.89 tokens per second)
0.00.764.463 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.764.464 I llama_perf_context_print:       total time =     468.34 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.267 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.515 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.125.537 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.139.242 I llama_init_from_model: n_seq_max     = 1
0.00.139.260 I llama_init_from_model: n_ctx         = 2048
0.00.139.260 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.139.260 I llama_init_from_model: n_batch       = 2048
0.00.139.261 I llama_init_from_model: n_ubatch      = 512
0.00.139.261 I llama_init_from_model: flash_attn    = 0
0.00.139.264 I llama_init_from_model: freq_base     = 10000.0
0.00.139.264 I llama_init_from_model: freq_scale    = 1
0.00.139.285 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.211.164 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.211.191 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.211.226 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.214.456 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.214.473 I llama_init_from_model: graph nodes  = 967
0.00.214.474 I llama_init_from_model: graph splits = 1
0.00.214.484 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.214.835 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.214.847 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.326.680 I main: llama threadpool init, n_threads = 4
0.00.326.701 I 
0.00.326.804 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.326.806 I 
0.00.326.896 I sampler seed: 1234
0.00.326.917 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.326.921 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.326.922 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.326.922 I 
...
0.02.827.937 I llama_perf_sampler_print:    sampling time =       2.41 ms /    71 runs   (    0.03 ms per token, 29460.58 tokens per second)
0.02.827.941 I llama_perf_context_print:        load time =     325.05 ms
0.02.827.942 I llama_perf_context_print: prompt eval time =     121.40 ms /     7 tokens (   17.34 ms per token,    57.66 tokens per second)
0.02.827.944 I llama_perf_context_print:        eval time =    2366.95 ms /    63 runs   (   37.57 ms per token,    26.62 tokens per second)
0.02.827.945 I llama_perf_context_print:       total time =    2502.39 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.382 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.404 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.125.420 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.139.209 I llama_init_from_model: n_seq_max     = 1
0.00.139.222 I llama_init_from_model: n_ctx         = 128
0.00.139.222 I llama_init_from_model: n_ctx_per_seq = 128
0.00.139.222 I llama_init_from_model: n_batch       = 128
0.00.139.222 I llama_init_from_model: n_ubatch      = 128
...
0.00.139.247 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.143.754 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.143.782 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.143.807 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.146.946 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.146.967 I llama_init_from_model: graph nodes  = 967
0.00.146.968 I llama_init_from_model: graph splits = 1
0.00.146.971 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.146.971 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.202.245 I 
0.00.202.361 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.202.383 I perplexity: tokenizing the input ..
0.00.208.379 I perplexity: tokenization took 5.992 ms
0.00.208.408 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.348.592 I perplexity: 1.14 seconds per pass - ETA 0.02 minutes
[1]10.0822,
0.01.352.491 I Final estimate: PPL = 10.0822 +/- 3.20340

0.01.352.535 I llama_perf_context_print:        load time =     201.82 ms
0.01.352.549 I llama_perf_context_print: prompt eval time =    1138.33 ms /   128 tokens (    8.89 ms per token,   112.45 tokens per second)
0.01.352.551 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.352.552 I llama_perf_context_print:       total time =    1150.29 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.298 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.132.768 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.132.790 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.146.585 I llama_init_from_model: n_seq_max     = 1
0.00.146.602 I llama_init_from_model: n_ctx         = 2048
0.00.146.602 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.146.603 I llama_init_from_model: n_batch       = 2048
0.00.146.603 I llama_init_from_model: n_ubatch      = 512
0.00.146.603 I llama_init_from_model: flash_attn    = 0
0.00.146.607 I llama_init_from_model: freq_base     = 10000.0
0.00.146.607 I llama_init_from_model: freq_scale    = 1
0.00.146.628 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.218.468 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.218.499 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.218.522 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.221.791 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.221.809 I llama_init_from_model: graph nodes  = 967
0.00.221.809 I llama_init_from_model: graph splits = 1
0.00.221.820 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.222.182 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.222.195 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.325.609 I main: llama threadpool init, n_threads = 4
0.00.325.629 I 
0.00.325.705 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.325.719 I 
0.00.325.827 I sampler seed: 1234
0.00.325.860 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.03.012.564 I llama_perf_sampler_print:    sampling time =       2.34 ms /    71 runs   (    0.03 ms per token, 30380.83 tokens per second)
0.03.012.567 I llama_perf_context_print:        load time =     323.96 ms
0.03.012.568 I llama_perf_context_print: prompt eval time =     139.16 ms /     7 tokens (   19.88 ms per token,    50.30 tokens per second)
0.03.012.569 I llama_perf_context_print:        eval time =    2535.99 ms /    63 runs   (   40.25 ms per token,    24.84 tokens per second)
0.03.012.570 I llama_perf_context_print:       total time =    2688.08 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.346 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.358 I print_info: file type   = Q5_1
0.00.021.361 I print_info: file size   = 1020.74 MiB (6.05 BPW) 
...
0.00.132.666 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.132.690 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.146.217 I llama_init_from_model: n_seq_max     = 1
0.00.146.231 I llama_init_from_model: n_ctx         = 128
0.00.146.232 I llama_init_from_model: n_ctx_per_seq = 128
0.00.146.232 I llama_init_from_model: n_batch       = 128
0.00.146.232 I llama_init_from_model: n_ubatch      = 128
0.00.146.233 I llama_init_from_model: flash_attn    = 0
0.00.146.236 I llama_init_from_model: freq_base     = 10000.0
0.00.146.237 I llama_init_from_model: freq_scale    = 1
0.00.146.238 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.146.259 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.150.950 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.150.973 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.151.001 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.154.273 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.154.289 I llama_init_from_model: graph nodes  = 967
0.00.154.289 I llama_init_from_model: graph splits = 1
0.00.154.293 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.154.293 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.214.571 I 
0.00.214.683 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.214.703 I perplexity: tokenizing the input ..
0.00.221.148 I perplexity: tokenization took 6.44 ms
0.00.221.177 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.198.935 I perplexity: 1.98 seconds per pass - ETA 0.02 minutes
[1]10.1864,
0.02.202.583 I Final estimate: PPL = 10.1864 +/- 3.18686

0.02.202.624 I llama_perf_context_print:        load time =     214.18 ms
0.02.202.625 I llama_perf_context_print: prompt eval time =    1975.76 ms /   128 tokens (   15.44 ms per token,    64.79 tokens per second)
0.02.202.627 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.202.628 I llama_perf_context_print:       total time =    1988.05 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.333 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.626 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.627 I llama_model_loader: - type q3_K:   48 tensors
0.00.021.627 I llama_model_loader: - type q6_K:    1 tensors
0.00.021.630 I print_info: file format = GGUF V3 (latest)
0.00.021.630 I print_info: file type   = Q2_K - Medium
0.00.021.633 I print_info: file size   = 542.04 MiB (3.21 BPW) 
...
0.00.102.269 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.102.285 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.116.064 I llama_init_from_model: n_seq_max     = 1
0.00.116.148 I llama_init_from_model: n_ctx         = 2048
0.00.116.148 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.116.148 I llama_init_from_model: n_batch       = 2048
0.00.116.149 I llama_init_from_model: n_ubatch      = 512
0.00.116.149 I llama_init_from_model: flash_attn    = 0
0.00.116.152 I llama_init_from_model: freq_base     = 10000.0
0.00.116.153 I llama_init_from_model: freq_scale    = 1
0.00.116.182 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.187.316 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.187.345 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.187.374 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.190.569 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.190.585 I llama_init_from_model: graph nodes  = 967
0.00.190.585 I llama_init_from_model: graph splits = 1
0.00.190.595 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.190.915 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.190.927 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.266.353 I main: llama threadpool init, n_threads = 4
0.00.266.373 I 
0.00.266.445 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.266.457 I 
0.00.266.548 I sampler seed: 1234
0.00.266.567 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.266.570 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.266.570 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.266.571 I 
...
0.01.814.154 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31682.28 tokens per second)
0.01.814.157 I llama_perf_context_print:        load time =     264.69 ms
0.01.814.158 I llama_perf_context_print: prompt eval time =      85.68 ms /     7 tokens (   12.24 ms per token,    81.70 tokens per second)
0.01.814.159 I llama_perf_context_print:        eval time =    1450.51 ms /    63 runs   (   23.02 ms per token,    43.43 tokens per second)
0.01.814.160 I llama_perf_context_print:       total time =    1548.88 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.317 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.244 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.020.685 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.688 I llama_model_loader: - type  f32:  194 tensors
0.00.020.688 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.688 I llama_model_loader: - type q3_K:   48 tensors
0.00.020.689 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.691 I print_info: file format = GGUF V3 (latest)
0.00.020.691 I print_info: file type   = Q2_K - Medium
0.00.020.694 I print_info: file size   = 542.04 MiB (3.21 BPW) 
...
0.00.101.021 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.101.035 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.117.320 I llama_init_from_model: n_seq_max     = 1
0.00.117.337 I llama_init_from_model: n_ctx         = 128
0.00.117.337 I llama_init_from_model: n_ctx_per_seq = 128
0.00.117.337 I llama_init_from_model: n_batch       = 128
0.00.117.337 I llama_init_from_model: n_ubatch      = 128
0.00.117.338 I llama_init_from_model: flash_attn    = 0
0.00.117.340 I llama_init_from_model: freq_base     = 10000.0
0.00.117.341 I llama_init_from_model: freq_scale    = 1
0.00.117.341 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.117.370 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.122.199 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.122.227 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.122.250 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.125.425 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.125.439 I llama_init_from_model: graph nodes  = 967
0.00.125.439 I llama_init_from_model: graph splits = 1
0.00.125.443 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.125.444 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.171.246 I 
0.00.171.362 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.171.371 I perplexity: tokenizing the input ..
0.00.177.761 I perplexity: tokenization took 6.385 ms
0.00.177.815 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.475.488 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.7471,
0.01.479.168 I Final estimate: PPL = 70.7471 +/- 27.47559

0.01.479.208 I llama_perf_context_print:        load time =     170.88 ms
0.01.479.209 I llama_perf_context_print: prompt eval time =    1295.77 ms /   128 tokens (   10.12 ms per token,    98.78 tokens per second)
0.01.479.211 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.479.212 I llama_perf_context_print:       total time =    1307.96 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.269 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.281 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.021.284 I llama_model_loader: - type  f32:  194 tensors
0.00.021.285 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.285 I llama_model_loader: - type q4_K:   71 tensors
...
0.00.064.491 I print_info: ssm_d_state      = 0
...
0.00.064.497 I print_info: n_merges         = 50009
...
0.00.110.498 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.110.519 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.193.784 I llama_init_from_model: n_seq_max     = 1
0.00.193.819 I llama_init_from_model: n_ctx         = 2048
0.00.193.826 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.193.833 I llama_init_from_model: n_batch       = 2048
0.00.193.840 I llama_init_from_model: n_ubatch      = 512
0.00.193.846 I llama_init_from_model: flash_attn    = 0
0.00.193.870 I llama_init_from_model: freq_base     = 10000.0
0.00.193.879 I llama_init_from_model: freq_scale    = 1
0.00.193.965 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.267.605 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.267.639 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.267.674 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.271.164 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.271.180 I llama_init_from_model: graph nodes  = 967
0.00.271.180 I llama_init_from_model: graph splits = 1
0.00.271.192 I common_init_from_params: added <|endoftext|> logit bias = -inf
...
0.00.352.921 I main: llama threadpool init, n_threads = 4
0.00.352.944 I 
0.00.353.015 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.353.029 I 
0.00.353.125 I sampler seed: 1234
0.00.353.146 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.353.150 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.353.150 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.353.150 I 
...
0.02.168.809 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31429.84 tokens per second)
0.02.168.811 I llama_perf_context_print:        load time =     351.30 ms
0.02.168.813 I llama_perf_context_print: prompt eval time =      67.88 ms /     7 tokens (    9.70 ms per token,   103.12 tokens per second)
0.02.168.814 I llama_perf_context_print:        eval time =    1736.01 ms /    63 runs   (   27.56 ms per token,    36.29 tokens per second)
0.02.168.814 I llama_perf_context_print:       total time =    1817.02 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.334 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.176 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.021.180 I llama_model_loader: - type q5_K:    1 tensors
0.00.021.180 I llama_model_loader: - type q6_K:    1 tensors
0.00.021.182 I print_info: file format = GGUF V3 (latest)
0.00.021.183 I print_info: file type   = Q3_K - Medium
0.00.021.185 I print_info: file size   = 724.27 MiB (4.29 BPW) 
...
0.00.109.453 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.109.473 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.195.475 I llama_init_from_model: n_seq_max     = 1
0.00.195.510 I llama_init_from_model: n_ctx         = 128
0.00.195.511 I llama_init_from_model: n_ctx_per_seq = 128
...
0.00.195.520 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.195.556 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.200.076 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.200.105 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.200.135 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.203.346 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.203.360 I llama_init_from_model: graph nodes  = 967
0.00.203.360 I llama_init_from_model: graph splits = 1
0.00.203.365 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.203.365 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.247.678 I 
0.00.247.788 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.247.811 I perplexity: tokenizing the input ..
0.00.254.253 I perplexity: tokenization took 6.439 ms
0.00.254.284 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.160.503 I perplexity: 0.91 seconds per pass - ETA 0.00 minutes
[1]12.3725,
0.01.164.242 I Final estimate: PPL = 12.3725 +/- 4.01345

0.01.164.289 I llama_perf_context_print:        load time =     247.28 ms
0.01.164.304 I llama_perf_context_print: prompt eval time =     904.30 ms /   128 tokens (    7.06 ms per token,   141.55 tokens per second)
0.01.164.306 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.164.307 I llama_perf_context_print:       total time =     916.61 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.265 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.049 I llama_model_loader: - type q4_K:   61 tensors
...
0.00.064.525 I print_info: f_norm_rms_eps   = 0.0e+00
...
0.00.064.540 I print_info: UNK token        = 0 '<|endoftext|>'
...
0.00.064.542 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.109.364 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.109.388 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.230.374 I llama_init_from_model: n_seq_max     = 1
0.00.230.392 I llama_init_from_model: n_ctx         = 2048
0.00.230.393 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.230.394 I llama_init_from_model: n_batch       = 2048
0.00.230.394 I llama_init_from_model: n_ubatch      = 512
0.00.230.395 I llama_init_from_model: flash_attn    = 0
0.00.230.401 I llama_init_from_model: freq_base     = 10000.0
0.00.230.403 I llama_init_from_model: freq_scale    = 1
0.00.230.433 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.304.320 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.304.354 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.304.394 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.307.859 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.307.875 I llama_init_from_model: graph nodes  = 967
0.00.307.876 I llama_init_from_model: graph splits = 1
0.00.307.890 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.308.196 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.308.208 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.410.240 I main: llama threadpool init, n_threads = 4
0.00.410.264 I 
0.00.410.332 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.410.345 I 
0.00.410.450 I sampler seed: 1234
0.00.410.484 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.410.487 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.410.488 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.410.488 I 
...
0.02.515.131 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31208.79 tokens per second)
0.02.515.134 I llama_perf_context_print:        load time =     408.67 ms
0.02.515.136 I llama_perf_context_print: prompt eval time =      65.44 ms /     7 tokens (    9.35 ms per token,   106.97 tokens per second)
0.02.515.137 I llama_perf_context_print:        eval time =    2027.72 ms /    63 runs   (   32.19 ms per token,    31.07 tokens per second)
0.02.515.137 I llama_perf_context_print:       total time =    2105.98 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.350 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.109.019 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.109.033 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.229.643 I llama_init_from_model: n_seq_max     = 1
0.00.229.678 I llama_init_from_model: n_ctx         = 128
0.00.229.685 I llama_init_from_model: n_ctx_per_seq = 128
0.00.229.692 I llama_init_from_model: n_batch       = 128
0.00.229.698 I llama_init_from_model: n_ubatch      = 128
0.00.229.705 I llama_init_from_model: flash_attn    = 0
0.00.229.716 I llama_init_from_model: freq_base     = 10000.0
0.00.229.725 I llama_init_from_model: freq_scale    = 1
0.00.229.732 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.229.767 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.234.525 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.234.568 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.234.607 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.238.015 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.238.049 I llama_init_from_model: graph nodes  = 967
0.00.238.056 I llama_init_from_model: graph splits = 1
0.00.238.066 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.238.075 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.300.591 I 
0.00.300.706 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.300.726 I perplexity: tokenizing the input ..
0.00.307.198 I perplexity: tokenization took 6.468 ms
0.00.307.229 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.882.061 I perplexity: 0.57 seconds per pass - ETA 0.00 minutes
[1]10.3355,
0.00.886.077 I Final estimate: PPL = 10.3355 +/- 3.28881

0.00.886.118 I llama_perf_context_print:        load time =     300.19 ms
0.00.886.132 I llama_perf_context_print: prompt eval time =     572.87 ms /   128 tokens (    4.48 ms per token,   223.44 tokens per second)
0.00.886.134 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.886.134 I llama_perf_context_print:       total time =     585.53 ms /   129 tokens
...
0.00.021.136 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.021.145 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
...
0.00.063.544 I print_info: EOG token        = 0 '<|endoftext|>'
...
0.00.114.405 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.114.427 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.248.258 I llama_init_from_model: n_seq_max     = 1
0.00.248.293 I llama_init_from_model: n_ctx         = 2048
0.00.248.300 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.248.307 I llama_init_from_model: n_batch       = 2048
0.00.248.313 I llama_init_from_model: n_ubatch      = 512
0.00.248.320 I llama_init_from_model: flash_attn    = 0
0.00.248.344 I llama_init_from_model: freq_base     = 10000.0
...
0.00.321.711 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.321.760 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.321.803 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.325.087 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.325.122 I llama_init_from_model: graph nodes  = 967
0.00.325.128 I llama_init_from_model: graph splits = 1
0.00.325.149 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.325.502 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.325.522 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.435.891 I main: llama threadpool init, n_threads = 4
0.00.435.914 I 
0.00.435.987 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.435.989 I 
0.00.436.087 I sampler seed: 1234
0.00.436.105 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.436.109 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.436.110 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.436.110 I 
...
0.02.998.303 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31795.79 tokens per second)
0.02.998.307 I llama_perf_context_print:        load time =     434.23 ms
0.02.998.308 I llama_perf_context_print: prompt eval time =      89.65 ms /     7 tokens (   12.81 ms per token,    78.08 tokens per second)
0.02.998.309 I llama_perf_context_print:        eval time =    2461.00 ms /    63 runs   (   39.06 ms per token,    25.60 tokens per second)
0.02.998.310 I llama_perf_context_print:       total time =    2563.54 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.376 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.232 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.232 I llama_model_loader: - type q6_K:   37 tensors
0.00.021.234 I print_info: file format = GGUF V3 (latest)
0.00.021.235 I print_info: file type   = Q5_K - Medium
0.00.021.238 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
...
0.00.064.480 I print_info: EOG token        = 0 '<|endoftext|>'
...
0.00.116.205 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.116.221 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.251.007 I llama_init_from_model: n_seq_max     = 1
0.00.251.042 I llama_init_from_model: n_ctx         = 128
0.00.251.049 I llama_init_from_model: n_ctx_per_seq = 128
0.00.251.056 I llama_init_from_model: n_batch       = 128
0.00.251.062 I llama_init_from_model: n_ubatch      = 128
0.00.251.063 I llama_init_from_model: flash_attn    = 0
0.00.251.068 I llama_init_from_model: freq_base     = 10000.0
0.00.251.069 I llama_init_from_model: freq_scale    = 1
0.00.251.070 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.251.098 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.255.749 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.255.781 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.255.817 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.259.255 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.259.271 I llama_init_from_model: graph nodes  = 967
0.00.259.272 I llama_init_from_model: graph splits = 1
0.00.259.278 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.259.278 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.335.652 I 
0.00.335.773 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.335.798 I perplexity: tokenizing the input ..
0.00.342.309 I perplexity: tokenization took 6.507 ms
0.00.342.340 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.013.949 I perplexity: 0.67 seconds per pass - ETA 0.00 minutes
[1]11.0242,
0.01.017.679 I Final estimate: PPL = 11.0242 +/- 3.53494

0.01.017.727 I llama_perf_context_print:        load time =     335.23 ms
0.01.017.745 I llama_perf_context_print: prompt eval time =     669.76 ms /   128 tokens (    5.23 ms per token,   191.11 tokens per second)
0.01.017.746 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.017.747 I llama_perf_context_print:       total time =     682.08 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.257 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.120.070 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.120.093 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.260.535 I llama_init_from_model: n_seq_max     = 1
0.00.260.566 I llama_init_from_model: n_ctx         = 2048
0.00.260.574 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.260.580 I llama_init_from_model: n_batch       = 2048
0.00.260.587 I llama_init_from_model: n_ubatch      = 512
0.00.260.593 I llama_init_from_model: flash_attn    = 0
0.00.260.604 I llama_init_from_model: freq_base     = 10000.0
0.00.260.613 I llama_init_from_model: freq_scale    = 1
0.00.260.647 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.334.688 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.334.736 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.334.777 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.338.091 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.338.125 I llama_init_from_model: graph nodes  = 967
0.00.338.131 I llama_init_from_model: graph splits = 1
0.00.338.150 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.338.503 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.338.523 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.456.907 I main: llama threadpool init, n_threads = 4
0.00.456.933 I 
0.00.457.008 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.457.021 I 
0.00.457.115 I sampler seed: 1234
0.00.457.136 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.457.139 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.457.140 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.457.140 I 
...
0.03.157.433 I llama_perf_sampler_print:    sampling time =       2.39 ms /    71 runs   (    0.03 ms per token, 29657.48 tokens per second)
0.03.157.436 I llama_perf_context_print:        load time =     455.29 ms
0.03.157.438 I llama_perf_context_print: prompt eval time =     119.32 ms /     7 tokens (   17.05 ms per token,    58.67 tokens per second)
0.03.157.439 I llama_perf_context_print:        eval time =    2568.55 ms /    63 runs   (   40.77 ms per token,    24.53 tokens per second)
0.03.157.440 I llama_perf_context_print:       total time =    2701.61 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.325 I build: 4782 (69050a11) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.674 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.020.680 I print_info: file type   = Q6_K
0.00.020.682 I print_info: file size   = 1.08 GiB (6.57 BPW) 
...
0.00.119.628 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.119.650 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.257.797 I llama_init_from_model: n_seq_max     = 1
0.00.257.828 I llama_init_from_model: n_ctx         = 128
0.00.257.835 I llama_init_from_model: n_ctx_per_seq = 128
0.00.257.842 I llama_init_from_model: n_batch       = 128
0.00.257.849 I llama_init_from_model: n_ubatch      = 128
0.00.257.855 I llama_init_from_model: flash_attn    = 0
0.00.257.879 I llama_init_from_model: freq_base     = 10000.0
0.00.257.888 I llama_init_from_model: freq_scale    = 1
0.00.257.895 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.257.929 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.262.530 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.262.574 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.262.612 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.266.075 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.266.110 I llama_init_from_model: graph nodes  = 967
0.00.266.117 I llama_init_from_model: graph splits = 1
0.00.266.127 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.266.134 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.359.907 I 
0.00.360.028 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.360.052 I perplexity: tokenizing the input ..
0.00.366.534 I perplexity: tokenization took 6.477 ms
0.00.366.565 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.183.923 I perplexity: 0.82 seconds per pass - ETA 0.00 minutes
[1]10.3482,
0.01.187.515 I Final estimate: PPL = 10.3482 +/- 3.30522

0.01.187.577 I llama_perf_context_print:        load time =     359.54 ms
0.01.187.593 I llama_perf_context_print: prompt eval time =     815.46 ms /   128 tokens (    6.37 ms per token,   156.97 tokens per second)
0.01.187.595 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.187.596 I llama_perf_context_print:       total time =     827.67 ms /   129 tokens
...
0.00.304.438 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.304.459 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_init_from_model: graph splits = 1
0.00.302.074 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.302.095 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_init_from_model: n_seq_max     = 1
llama_init_from_model: n_ctx         = 2048
llama_init_from_model: n_ctx_per_seq = 2048
...
0.47user 0.66system 0:01.13elapsed 100%CPU (0avgtext+0avgdata 5352624maxresident)k
