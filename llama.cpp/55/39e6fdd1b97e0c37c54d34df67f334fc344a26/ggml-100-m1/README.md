...
- status:  SUCCESS ✅
- runtime: 579.21
- date:    Mon Apr 29 21:02:29 EEST 2024
...
Label Time Summary:
main    = 152.30 sec*proc (21 tests)

Total Test time (real) = 152.31 sec
...
10/21 Test #10: test-tokenizer-1-llama-spm ........   Passed    0.55 sec
      Start 11: test-quantize-fns
11/21 Test #11: test-quantize-fns .................   Passed   19.80 sec
      Start 12: test-quantize-perf
...
llama_print_timings:        load time =      56.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       9.88 ms /     9 tokens (    1.10 ms per token,   910.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      32.18 ms /    10 tokens
...
# Create a button
button = tk.Button(
llama_print_timings:        load time =    3219.14 ms
llama_print_timings:      sample time =      18.20 ms /    32 runs   (    0.57 ms per token,  1758.05 tokens per second)
llama_print_timings: prompt eval time =     191.22 ms /     2 tokens (   95.61 ms per token,    10.46 tokens per second)
llama_print_timings:        eval time =    1611.36 ms /    31 runs   (   51.98 ms per token,    19.24 tokens per second)
llama_print_timings:       total time =    1895.94 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soirée is a fashion brand that celebrates individuality and inclusivity. We believe that fashion should empower people to express their unique style and celebrate who they are.

**
llama_print_timings:        load time =    3679.83 ms
llama_print_timings:      sample time =      18.42 ms /    32 runs   (    0.58 ms per token,  1737.15 tokens per second)
llama_print_timings: prompt eval time =     200.13 ms /     2 tokens (  100.07 ms per token,     9.99 tokens per second)
llama_print_timings:        eval time =    1511.02 ms /    31 runs   (   48.74 ms per token,    20.52 tokens per second)
...
<bos> Heuristics are mental shortcuts used to make decisions. They are often based on intuition, experience, or simple availability. Heuristics are widely used in various settings
llama_print_timings:        load time =    3409.55 ms
...
llama_print_timings:        eval time =    1513.59 ms /    31 runs   (   48.83 ms per token,    20.48 tokens per second)
llama_print_timings:       total time =    1804.84 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21579.81 ms
main:    total time = 21579.81 ms
+ echo PASS
PASS
+ echo
...
<bos> The Legend of Zelda: Breath of the Wild is an epic adventure game that will capture the imaginations of players around the world.

**Imagine:**

* A vast
llama_print_timings:        load time =    1744.56 ms
llama_print_timings:      sample time =      18.47 ms /    32 runs   (    0.58 ms per token,  1732.26 tokens per second)
llama_print_timings: prompt eval time =     212.67 ms /     2 tokens (  106.33 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1092.47 ms /    31 runs   (   35.24 ms per token,    28.38 tokens per second)
llama_print_timings:       total time =    1397.23 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21844.46 ms
main:    total time = 21844.46 ms
+ echo PASS
PASS
+ echo
...
<bos> After much research, I have narrowed my choices down to two companies for an investment:

**1. Tesla (TSLA)**
**2. Lucid Motors (
llama_print_timings:        load time =    1869.14 ms
llama_print_timings:      sample time =      18.27 ms /    32 runs   (    0.57 ms per token,  1751.31 tokens per second)
llama_print_timings: prompt eval time =     215.13 ms /     2 tokens (  107.57 ms per token,     9.30 tokens per second)
llama_print_timings:        eval time =    1103.53 ms /    31 runs   (   35.60 ms per token,    28.09 tokens per second)
llama_print_timings:       total time =    1411.73 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
