...
- status:  FAILURE ❌ (139)
- runtime: 2:33.41
- date:    Sun Dec 22 20:33:03 UTC 2024
...
18/28 Test #18: test-json-schema-to-grammar .......   Passed    3.47 sec
...
0.00.000.657 I build: 4373 (dcbfda1f) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.065 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.007.819 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.007.821 I llama_model_loader: - type  f32:  124 tensors
0.00.007.822 I llama_model_loader: - type  f16:   73 tensors
...
0.00.022.136 I llm_load_print_meta: n_head           = 12
0.00.022.137 I llm_load_print_meta: n_head_kv        = 12
0.00.022.138 I llm_load_print_meta: n_rot            = 32
...
0.00.022.140 I llm_load_print_meta: n_gqa            = 1
...
0.00.022.149 I llm_load_print_meta: causal attn      = 0
...
0.00.022.163 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.022.163 I llm_load_print_meta: max token length = 21
0.00.026.635 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.026.650 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.041.403 I llama_new_context_with_model: n_seq_max     = 1
0.00.041.418 I llama_new_context_with_model: n_ctx         = 512
0.00.041.419 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.041.419 I llama_new_context_with_model: n_batch       = 2048
0.00.041.420 I llama_new_context_with_model: n_ubatch      = 2048
0.00.041.420 I llama_new_context_with_model: flash_attn    = 0
0.00.041.422 I llama_new_context_with_model: freq_base     = 10000.0
0.00.041.423 I llama_new_context_with_model: freq_scale    = 1
0.00.041.441 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12
0.00.044.090 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.044.118 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.044.125 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.046.349 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.046.367 I llama_new_context_with_model: graph nodes  = 429
0.00.046.367 I llama_new_context_with_model: graph splits = 1
0.00.046.370 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.046.370 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.049.819 I 
0.00.049.911 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.055.806 I llama_perf_context_print:        load time =      49.12 ms
0.00.055.808 I llama_perf_context_print: prompt eval time =       3.92 ms /     9 tokens (    0.44 ms per token,  2298.26 tokens per second)
0.00.055.810 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.055.811 I llama_perf_context_print:       total time =       5.99 ms /    10 tokens
ci/run.sh: line 709: 3285554 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_f16} -p "I believe the meaning of life is" -ngl 99 -c 0
