...
- status:  SUCCESS ✅
- runtime: 4:15.42
- date:    Thu Dec 12 17:40:05 UTC 2024
...
0.00.000.801 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.788 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
...
0.00.021.405 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.021.432 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.433 I llm_load_print_meta: n_embd           = 384
0.00.021.433 I llm_load_print_meta: n_layer          = 12
...
0.00.021.444 I llm_load_print_meta: n_embd_head_v    = 32
...
0.00.021.448 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.448 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.448 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.449 I llm_load_print_meta: f_logit_scale    = 0.0e+00
...
0.00.021.487 I llm_load_print_meta: freq_scale_train = 1
...
0.00.021.489 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.021.499 I llm_load_print_meta: CLS token        = 101 '[CLS]'
...
0.00.025.164 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.179 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
...
0.00.037.798 I llama_new_context_with_model: flash_attn    = 0
0.00.037.800 I llama_new_context_with_model: freq_base     = 10000.0
0.00.037.801 I llama_new_context_with_model: freq_scale    = 1
...
0.00.040.251 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.042.378 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.042.400 I llama_new_context_with_model: graph nodes  = 429
0.00.042.401 I llama_new_context_with_model: graph splits = 1
0.00.042.403 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.045.655 I 
0.00.045.740 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.051.506 I llama_perf_context_print:        load time =      44.81 ms
0.00.051.508 I llama_perf_context_print: prompt eval time =       3.85 ms /     9 tokens (    0.43 ms per token,  2337.66 tokens per second)
0.00.051.509 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.051.510 I llama_perf_context_print:       total time =       5.85 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.259 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.380 I llama_model_loader: - kv   3:                           general.basename str              = bge
...
0.00.003.390 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
...
0.00.003.391 I llama_model_loader: - kv  16:                         tokenizer.ggml.pre str              = jina-v2-en
0.00.006.475 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.007.258 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.258 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.007.259 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.007.259 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.007.260 I llama_model_loader: - type  f32:  124 tensors
0.00.007.261 I llama_model_loader: - type q8_0:   73 tensors
0.00.017.977 I llm_load_vocab: special tokens cache size = 5
0.00.020.536 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.563 I llm_load_print_meta: format           = GGUF V3 (latest)
...
0.00.020.567 I llm_load_print_meta: n_ctx_train      = 512
0.00.020.567 I llm_load_print_meta: n_embd           = 384
0.00.020.567 I llm_load_print_meta: n_layer          = 12
0.00.020.574 I llm_load_print_meta: n_head           = 12
0.00.020.575 I llm_load_print_meta: n_head_kv        = 12
0.00.020.575 I llm_load_print_meta: n_rot            = 32
0.00.020.576 I llm_load_print_meta: n_swa            = 0
0.00.020.576 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.576 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.577 I llm_load_print_meta: n_gqa            = 1
0.00.020.578 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.578 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.580 I llm_load_print_meta: f_norm_eps       = 1.0e-12
...
0.00.020.583 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.585 I llm_load_print_meta: n_ff             = 1536
0.00.020.586 I llm_load_print_meta: n_expert         = 0
0.00.020.586 I llm_load_print_meta: n_expert_used    = 0
0.00.020.586 I llm_load_print_meta: causal attn      = 0
...
0.00.020.591 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.591 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.591 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.592 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.592 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.593 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.593 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.593 I llm_load_print_meta: model type       = 33M
0.00.020.594 I llm_load_print_meta: model ftype      = Q8_0
0.00.020.595 I llm_load_print_meta: model params     = 33.21 M
0.00.020.596 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.020.597 I llm_load_print_meta: general.name     = Bge Small
0.00.020.597 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.598 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.598 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.598 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.600 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.600 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.600 I llm_load_print_meta: max token length = 21
0.00.023.274 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.023.288 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.032.536 I llama_new_context_with_model: n_seq_max     = 1
0.00.032.554 I llama_new_context_with_model: n_ctx         = 512
0.00.032.556 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.032.557 I llama_new_context_with_model: n_batch       = 2048
0.00.032.558 I llama_new_context_with_model: n_ubatch      = 2048
0.00.032.559 I llama_new_context_with_model: flash_attn    = 0
0.00.032.561 I llama_new_context_with_model: freq_base     = 10000.0
0.00.032.562 I llama_new_context_with_model: freq_scale    = 1
0.00.034.980 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
...
0.00.036.570 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.036.590 I llama_new_context_with_model: graph nodes  = 429
0.00.036.590 I llama_new_context_with_model: graph splits = 1
0.00.036.592 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.929 I 
0.00.039.007 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.043.894 I llama_perf_context_print:        load time =      38.63 ms
0.00.043.896 I llama_perf_context_print: prompt eval time =       2.39 ms /     9 tokens (    0.27 ms per token,  3762.54 tokens per second)
0.00.043.898 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.043.899 I llama_perf_context_print:       total time =       4.97 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.646 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.648 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.649 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.650 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.650 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.653 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.656 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.656 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
...
0.00.008.661 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.662 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.662 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.663 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.663 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.756 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.016.174 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.715 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.732 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.732 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.732 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.733 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.733 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.734 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.734 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.734 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.735 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.736 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.736 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.738 I llama_model_loader: - type  f32:   41 tensors
0.00.019.739 I llama_model_loader: - type  f16:   29 tensors
0.00.037.652 W llm_load_vocab: empty token at index 5
...
0.00.061.237 I llm_load_vocab: special tokens cache size = 5
0.00.341.552 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.341.574 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.341.574 I llm_load_print_meta: arch             = jina-bert-v2
0.00.341.575 I llm_load_print_meta: vocab type       = BPE
0.00.341.576 I llm_load_print_meta: n_vocab          = 61056
0.00.341.576 I llm_load_print_meta: n_merges         = 39382
0.00.341.576 I llm_load_print_meta: vocab_only       = 0
0.00.341.577 I llm_load_print_meta: n_ctx_train      = 8192
0.00.341.577 I llm_load_print_meta: n_embd           = 384
0.00.341.577 I llm_load_print_meta: n_layer          = 4
0.00.341.585 I llm_load_print_meta: n_head           = 12
0.00.341.586 I llm_load_print_meta: n_head_kv        = 12
0.00.341.587 I llm_load_print_meta: n_rot            = 32
0.00.341.587 I llm_load_print_meta: n_swa            = 0
0.00.341.587 I llm_load_print_meta: n_embd_head_k    = 32
0.00.341.587 I llm_load_print_meta: n_embd_head_v    = 32
0.00.341.588 I llm_load_print_meta: n_gqa            = 1
0.00.341.589 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.341.590 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.341.592 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.341.592 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.341.592 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.341.593 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.341.593 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.341.594 I llm_load_print_meta: n_ff             = 1536
0.00.341.594 I llm_load_print_meta: n_expert         = 0
0.00.341.595 I llm_load_print_meta: n_expert_used    = 0
0.00.341.595 I llm_load_print_meta: causal attn      = 0
0.00.341.595 I llm_load_print_meta: pooling type     = -1
0.00.341.596 I llm_load_print_meta: rope type        = -1
0.00.341.596 I llm_load_print_meta: rope scaling     = linear
0.00.341.597 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.341.598 I llm_load_print_meta: freq_scale_train = 1
0.00.341.598 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.341.598 I llm_load_print_meta: rope_finetuned   = unknown
0.00.341.599 I llm_load_print_meta: ssm_d_conv       = 0
0.00.341.599 I llm_load_print_meta: ssm_d_inner      = 0
0.00.341.599 I llm_load_print_meta: ssm_d_state      = 0
0.00.341.599 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.341.600 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.341.600 I llm_load_print_meta: model type       = 33M
0.00.341.601 I llm_load_print_meta: model ftype      = F16
0.00.341.602 I llm_load_print_meta: model params     = 32.90 M
0.00.341.603 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.341.603 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.341.603 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.341.604 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.341.604 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.341.604 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.341.605 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.341.605 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.341.605 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.341.606 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.341.606 I llm_load_print_meta: max token length = 45
0.00.344.878 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.344.896 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.352.728 I llama_new_context_with_model: n_seq_max     = 1
0.00.352.749 I llama_new_context_with_model: n_ctx         = 8192
0.00.352.750 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.352.750 I llama_new_context_with_model: n_batch       = 2048
0.00.352.751 I llama_new_context_with_model: n_ubatch      = 2048
0.00.352.751 I llama_new_context_with_model: flash_attn    = 0
0.00.352.753 I llama_new_context_with_model: freq_base     = 10000.0
0.00.352.754 I llama_new_context_with_model: freq_scale    = 1
0.00.361.842 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.361.867 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.874 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.363.170 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.363.191 I llama_new_context_with_model: graph nodes  = 154
0.00.363.191 I llama_new_context_with_model: graph splits = 1
0.00.363.193 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.432 I 
0.00.371.518 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.722 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.735 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.740 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.740 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.744 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.744 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.671 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.199 I llama_perf_context_print:        load time =     370.74 ms
0.00.383.201 I llama_perf_context_print: prompt eval time =       7.31 ms /    62 tokens (    0.12 ms per token,  8486.18 tokens per second)
0.00.383.202 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.203 I llama_perf_context_print:       total time =      11.77 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.754 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.016 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.017 I llm_load_print_meta: model params     = 1.41 B
0.00.076.018 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.201.077 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.201.094 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.990.168 I llama_new_context_with_model: n_seq_max     = 1
0.00.990.190 I llama_new_context_with_model: n_ctx         = 2048
0.00.990.191 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.990.191 I llama_new_context_with_model: n_batch       = 2048
0.00.990.192 I llama_new_context_with_model: n_ubatch      = 512
0.00.990.192 I llama_new_context_with_model: flash_attn    = 0
0.00.990.197 I llama_new_context_with_model: freq_base     = 10000.0
0.00.990.198 I llama_new_context_with_model: freq_scale    = 1
0.01.058.275 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.058.303 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.058.335 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.060.629 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.060.646 I llama_new_context_with_model: graph nodes  = 967
0.01.060.646 I llama_new_context_with_model: graph splits = 1
0.01.060.651 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.158.456 I main: llama threadpool init, n_threads = 4
0.01.158.486 I 
0.01.158.565 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.158.579 I 
0.01.158.767 I sampler seed: 1234
0.01.158.787 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.158.790 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.158.791 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.158.791 I 
...
0.04.942.182 I llama_perf_sampler_print:    sampling time =       2.55 ms /    71 runs   (    0.04 ms per token, 27799.53 tokens per second)
0.04.942.186 I llama_perf_context_print:        load time =    1157.41 ms
0.04.942.187 I llama_perf_context_print: prompt eval time =      94.02 ms /     7 tokens (   13.43 ms per token,    74.46 tokens per second)
0.04.942.188 I llama_perf_context_print:        eval time =    3677.94 ms /    63 runs   (   58.38 ms per token,    17.13 tokens per second)
0.04.942.189 I llama_perf_context_print:       total time =    3783.73 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.717 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.202.151 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.202.171 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.991.884 I llama_new_context_with_model: n_seq_max     = 1
0.00.991.905 I llama_new_context_with_model: n_ctx         = 128
0.00.991.906 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.991.906 I llama_new_context_with_model: n_batch       = 128
0.00.991.906 I llama_new_context_with_model: n_ubatch      = 128
0.00.991.907 I llama_new_context_with_model: flash_attn    = 0
0.00.991.911 I llama_new_context_with_model: freq_base     = 10000.0
0.00.991.912 I llama_new_context_with_model: freq_scale    = 1
0.00.991.913 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.996.895 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.996.924 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.996.952 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.999.282 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.999.300 I llama_new_context_with_model: graph nodes  = 967
0.00.999.300 I llama_new_context_with_model: graph splits = 1
0.00.999.302 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.063.413 I 
0.01.063.522 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.063.531 I perplexity: tokenizing the input ..
0.01.073.126 I perplexity: tokenization took 9.591 ms
0.01.073.156 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.966.883 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.970.801 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.970.846 I llama_perf_context_print:        load time =    1062.66 ms
0.01.970.859 I llama_perf_context_print: prompt eval time =     891.96 ms /   128 tokens (    6.97 ms per token,   143.50 tokens per second)
0.01.970.860 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.970.861 I llama_perf_context_print:       total time =     907.43 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.786 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.001.016 I main: llama backend init
0.00.001.033 I main: load the model and apply lora adapter, if any
0.00.010.086 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.075.701 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.702 I llm_load_print_meta: model params     = 1.41 B
0.00.075.703 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.166.315 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.166.332 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.334.933 I llama_new_context_with_model: n_seq_max     = 1
0.00.334.955 I llama_new_context_with_model: n_ctx         = 2048
0.00.334.955 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.334.955 I llama_new_context_with_model: n_batch       = 2048
0.00.334.956 I llama_new_context_with_model: n_ubatch      = 512
0.00.334.956 I llama_new_context_with_model: flash_attn    = 0
0.00.334.962 I llama_new_context_with_model: freq_base     = 10000.0
0.00.334.962 I llama_new_context_with_model: freq_scale    = 1
0.00.403.276 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.403.305 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.403.338 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.406.224 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.406.247 I llama_new_context_with_model: graph nodes  = 967
0.00.406.247 I llama_new_context_with_model: graph splits = 1
0.00.406.253 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.482.943 I main: llama threadpool init, n_threads = 4
0.00.482.973 I 
0.00.483.063 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.483.065 I 
0.00.483.204 I sampler seed: 1234
0.00.483.229 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.483.232 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.483.232 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.483.232 I 
...
0.02.609.871 I llama_perf_sampler_print:    sampling time =       2.54 ms /    71 runs   (    0.04 ms per token, 27974.78 tokens per second)
0.02.609.875 I llama_perf_context_print:        load time =     481.89 ms
0.02.609.876 I llama_perf_context_print: prompt eval time =      46.50 ms /     7 tokens (    6.64 ms per token,   150.53 tokens per second)
0.02.609.877 I llama_perf_context_print:        eval time =    2068.71 ms /    63 runs   (   32.84 ms per token,    30.45 tokens per second)
0.02.609.878 I llama_perf_context_print:       total time =    2126.94 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.780 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.244 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.076.163 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.164 I llm_load_print_meta: model params     = 1.41 B
0.00.076.165 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.166.190 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.166.207 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.324.631 I llama_new_context_with_model: n_seq_max     = 1
0.00.324.666 I llama_new_context_with_model: n_ctx         = 128
0.00.324.673 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.324.680 I llama_new_context_with_model: n_batch       = 128
0.00.324.687 I llama_new_context_with_model: n_ubatch      = 128
0.00.324.693 I llama_new_context_with_model: flash_attn    = 0
0.00.324.704 I llama_new_context_with_model: freq_base     = 10000.0
0.00.324.713 I llama_new_context_with_model: freq_scale    = 1
0.00.324.720 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.329.447 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.329.487 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.329.518 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.332.350 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.332.378 I llama_new_context_with_model: graph nodes  = 967
0.00.332.385 I llama_new_context_with_model: graph splits = 1
0.00.332.394 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.388.043 I 
0.00.388.159 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.388.180 I perplexity: tokenizing the input ..
0.00.398.001 I perplexity: tokenization took 9.816 ms
0.00.398.036 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.772.290 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.00.775.980 I Final estimate: PPL = 10.1288 +/- 3.22324

0.00.776.019 I llama_perf_context_print:        load time =     387.22 ms
0.00.776.021 I llama_perf_context_print: prompt eval time =     372.45 ms /   128 tokens (    2.91 ms per token,   343.67 tokens per second)
0.00.776.022 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.776.023 I llama_perf_context_print:       total time =     387.98 ms /   129 tokens
...
..............................................................................
0.00.231.890 I llama_new_context_with_model: n_seq_max     = 1
0.00.231.914 I llama_new_context_with_model: n_ctx         = 2048
0.00.231.914 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.231.914 I llama_new_context_with_model: n_batch       = 2048
0.00.231.914 I llama_new_context_with_model: n_ubatch      = 512
0.00.231.915 I llama_new_context_with_model: flash_attn    = 0
0.00.231.920 I llama_new_context_with_model: freq_base     = 10000.0
0.00.231.922 I llama_new_context_with_model: freq_scale    = 1
0.00.299.878 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.299.910 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.299.945 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.302.857 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.302.873 I llama_new_context_with_model: graph nodes  = 967
0.00.302.873 I llama_new_context_with_model: graph splits = 1
0.00.302.878 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.372.892 I main: llama threadpool init, n_threads = 4
0.00.372.923 I 
0.00.373.011 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.373.011 I 
0.00.373.146 I sampler seed: 1234
0.00.373.167 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.373.170 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.373.171 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.373.171 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.803.080 I llama_perf_sampler_print:    sampling time =       2.66 ms /    71 runs   (    0.04 ms per token, 26671.68 tokens per second)
0.01.803.083 I llama_perf_context_print:        load time =     372.06 ms
0.01.803.084 I llama_perf_context_print: prompt eval time =      44.81 ms /     7 tokens (    6.40 ms per token,   156.23 tokens per second)
0.01.803.085 I llama_perf_context_print:        eval time =    1373.76 ms /    63 runs   (   21.81 ms per token,    45.86 tokens per second)
0.01.803.086 I llama_perf_context_print:       total time =    1430.19 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.669 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.330 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.387 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.388 I llm_load_print_meta: model params     = 1.41 B
0.00.075.388 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.021 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.233.299 I llama_new_context_with_model: n_seq_max     = 1
0.00.233.321 I llama_new_context_with_model: n_ctx         = 128
0.00.233.322 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.233.322 I llama_new_context_with_model: n_batch       = 128
0.00.233.322 I llama_new_context_with_model: n_ubatch      = 128
0.00.233.323 I llama_new_context_with_model: flash_attn    = 0
0.00.233.328 I llama_new_context_with_model: freq_base     = 10000.0
0.00.233.329 I llama_new_context_with_model: freq_scale    = 1
0.00.233.330 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.238.194 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.238.221 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.238.298 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.241.059 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.241.080 I llama_new_context_with_model: graph nodes  = 967
0.00.241.080 I llama_new_context_with_model: graph splits = 1
0.00.241.083 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.288.390 I 
0.00.288.515 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.288.543 I perplexity: tokenizing the input ..
0.00.298.381 I perplexity: tokenization took 9.841 ms
0.00.298.411 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.722.562 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.726.305 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.726.347 I llama_perf_context_print:        load time =     287.68 ms
0.00.726.361 I llama_perf_context_print: prompt eval time =     422.40 ms /   128 tokens (    3.30 ms per token,   303.03 tokens per second)
0.00.726.362 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.726.363 I llama_perf_context_print:       total time =     437.96 ms /   129 tokens
...
0.00.076.128 I llm_load_print_meta: n_embd_v_gqa     = 2048
...
0.00.076.138 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.139 I llm_load_print_meta: model params     = 1.41 B
0.00.076.140 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.460 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.487 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.240.171 I llama_new_context_with_model: n_seq_max     = 1
0.00.240.194 I llama_new_context_with_model: n_ctx         = 2048
0.00.240.194 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.240.195 I llama_new_context_with_model: n_batch       = 2048
0.00.240.195 I llama_new_context_with_model: n_ubatch      = 512
0.00.240.196 I llama_new_context_with_model: flash_attn    = 0
0.00.240.201 I llama_new_context_with_model: freq_base     = 10000.0
0.00.240.202 I llama_new_context_with_model: freq_scale    = 1
0.00.308.271 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.308.301 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.308.334 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.310.535 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.310.558 I llama_new_context_with_model: graph nodes  = 967
0.00.310.558 I llama_new_context_with_model: graph splits = 1
0.00.310.563 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.379.555 I main: llama threadpool init, n_threads = 4
0.00.379.585 I 
0.00.379.671 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.379.671 I 
0.00.379.798 I sampler seed: 1234
0.00.379.821 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.379.824 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.379.824 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.379.825 I 
...
0.01.903.901 I llama_perf_sampler_print:    sampling time =       2.51 ms /    71 runs   (    0.04 ms per token, 28253.08 tokens per second)
0.01.903.905 I llama_perf_context_print:        load time =     378.62 ms
0.01.903.906 I llama_perf_context_print: prompt eval time =      41.64 ms /     7 tokens (    5.95 ms per token,   168.10 tokens per second)
0.01.903.908 I llama_perf_context_print:        eval time =    1471.09 ms /    63 runs   (   23.35 ms per token,    42.83 tokens per second)
0.01.903.909 I llama_perf_context_print:       total time =    1524.35 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.311 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.932 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.008.975 I llama_model_loader: - kv   4:                         general.size_label str              = 1.4B
0.00.008.979 I llama_model_loader: - kv   5:                     gptneox.context_length u32              = 2048
0.00.008.979 I llama_model_loader: - kv   6:                   gptneox.embedding_length u32              = 2048
0.00.008.980 I llama_model_loader: - kv   7:                        gptneox.block_count u32              = 24
0.00.008.980 I llama_model_loader: - kv   8:                gptneox.feed_forward_length u32              = 8192
0.00.008.980 I llama_model_loader: - kv   9:               gptneox.rope.dimension_count u32              = 32
0.00.008.981 I llama_model_loader: - kv  10:               gptneox.attention.head_count u32              = 16
...
0.00.020.529 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.131.636 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.131.654 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.239.574 I llama_new_context_with_model: n_seq_max     = 1
0.00.239.597 I llama_new_context_with_model: n_ctx         = 128
0.00.239.597 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.239.597 I llama_new_context_with_model: n_batch       = 128
0.00.239.598 I llama_new_context_with_model: n_ubatch      = 128
0.00.239.598 I llama_new_context_with_model: flash_attn    = 0
0.00.239.603 I llama_new_context_with_model: freq_base     = 10000.0
0.00.239.604 I llama_new_context_with_model: freq_scale    = 1
0.00.239.605 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.244.427 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.244.454 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.244.478 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.246.829 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.246.851 I llama_new_context_with_model: graph nodes  = 967
0.00.246.851 I llama_new_context_with_model: graph splits = 1
0.00.246.854 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.288.748 I 
0.00.288.863 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.288.884 I perplexity: tokenizing the input ..
0.00.298.571 I perplexity: tokenization took 9.684 ms
0.00.298.605 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.750.161 I perplexity: 0.45 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.753.840 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.753.881 I llama_perf_context_print:        load time =     288.40 ms
0.00.753.883 I llama_perf_context_print: prompt eval time =     449.81 ms /   128 tokens (    3.51 ms per token,   284.57 tokens per second)
0.00.753.884 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.753.884 I llama_perf_context_print:       total time =     465.13 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.272 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.617 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.618 I llm_load_print_meta: model params     = 1.41 B
0.00.075.619 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.136.790 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.807 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.152.249 I llama_new_context_with_model: n_seq_max     = 1
0.00.152.272 I llama_new_context_with_model: n_ctx         = 2048
0.00.152.273 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.152.273 I llama_new_context_with_model: n_batch       = 2048
0.00.152.273 I llama_new_context_with_model: n_ubatch      = 512
0.00.152.274 I llama_new_context_with_model: flash_attn    = 0
0.00.152.278 I llama_new_context_with_model: freq_base     = 10000.0
0.00.152.279 I llama_new_context_with_model: freq_scale    = 1
0.00.221.008 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.221.037 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.221.066 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.223.289 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.223.312 I llama_new_context_with_model: graph nodes  = 967
0.00.223.312 I llama_new_context_with_model: graph splits = 1
0.00.223.317 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.319.225 I main: llama threadpool init, n_threads = 4
0.00.319.256 I 
0.00.319.344 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.319.357 I 
0.00.319.492 I sampler seed: 1234
0.00.319.512 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.319.553 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.594.119 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27551.42 tokens per second)
0.02.594.122 I llama_perf_context_print:        load time =     318.70 ms
0.02.594.124 I llama_perf_context_print: prompt eval time =      75.87 ms /     7 tokens (   10.84 ms per token,    92.27 tokens per second)
0.02.594.125 I llama_perf_context_print:        eval time =    2186.80 ms /    63 runs   (   34.71 ms per token,    28.81 tokens per second)
0.02.594.125 I llama_perf_context_print:       total time =    2274.90 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.321 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.932 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.020.561 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.020.564 I llama_model_loader: - type  f32:  194 tensors
0.00.020.564 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.135.822 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
...
0.00.151.507 I llama_new_context_with_model: n_ctx         = 128
0.00.151.507 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.151.507 I llama_new_context_with_model: n_batch       = 128
0.00.151.507 I llama_new_context_with_model: n_ubatch      = 128
0.00.151.508 I llama_new_context_with_model: flash_attn    = 0
0.00.151.511 I llama_new_context_with_model: freq_base     = 10000.0
0.00.151.512 I llama_new_context_with_model: freq_scale    = 1
0.00.151.512 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.156.462 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.156.488 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.156.505 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.158.704 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.158.720 I llama_new_context_with_model: graph nodes  = 967
...
0.00.222.735 I 
0.00.222.846 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.222.866 I perplexity: tokenizing the input ..
0.00.232.294 I perplexity: tokenization took 9.424 ms
0.00.232.327 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.321.936 I perplexity: 1.09 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.325.647 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.325.686 I llama_perf_context_print:        load time =     222.36 ms
0.01.325.687 I llama_perf_context_print: prompt eval time =    1087.54 ms /   128 tokens (    8.50 ms per token,   117.70 tokens per second)
0.01.325.688 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.325.689 I llama_perf_context_print:       total time =    1102.95 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.313 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.548 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.549 I llm_load_print_meta: model params     = 1.41 B
0.00.075.550 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.140.045 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.066 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.155.641 I llama_new_context_with_model: n_seq_max     = 1
0.00.155.664 I llama_new_context_with_model: n_ctx         = 2048
0.00.155.665 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.155.665 I llama_new_context_with_model: n_batch       = 2048
0.00.155.665 I llama_new_context_with_model: n_ubatch      = 512
0.00.155.666 I llama_new_context_with_model: flash_attn    = 0
0.00.155.669 I llama_new_context_with_model: freq_base     = 10000.0
0.00.155.670 I llama_new_context_with_model: freq_scale    = 1
0.00.224.979 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.225.002 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.225.029 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.227.241 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.227.264 I llama_new_context_with_model: graph nodes  = 967
0.00.227.264 I llama_new_context_with_model: graph splits = 1
0.00.227.268 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.325.909 I main: llama threadpool init, n_threads = 4
0.00.325.943 I 
0.00.326.031 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.326.044 I 
0.00.326.169 I sampler seed: 1234
0.00.326.188 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.326.192 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.326.192 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.326.192 I 
...
0.02.740.654 I llama_perf_sampler_print:    sampling time =       2.53 ms /    71 runs   (    0.04 ms per token, 28041.07 tokens per second)
0.02.740.656 I llama_perf_context_print:        load time =     325.24 ms
0.02.740.658 I llama_perf_context_print: prompt eval time =     121.14 ms /     7 tokens (   17.31 ms per token,    57.78 tokens per second)
0.02.740.661 I llama_perf_context_print:        eval time =    2282.04 ms /    63 runs   (   36.22 ms per token,    27.61 tokens per second)
0.02.740.662 I llama_perf_context_print:       total time =    2414.75 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.320 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.133 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.020.732 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.074.517 I llm_load_print_meta: arch             = gptneox
0.00.074.518 I llm_load_print_meta: vocab type       = BPE
0.00.074.518 I llm_load_print_meta: n_vocab          = 50304
...
0.00.074.528 I llm_load_print_meta: n_head           = 16
...
0.00.074.543 I llm_load_print_meta: model ftype      = Q5_1
0.00.074.544 I llm_load_print_meta: model params     = 1.41 B
0.00.074.545 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.074.548 I llm_load_print_meta: max token length = 1024
0.00.140.675 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.691 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.156.001 I llama_new_context_with_model: n_seq_max     = 1
0.00.156.024 I llama_new_context_with_model: n_ctx         = 128
0.00.156.024 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.156.024 I llama_new_context_with_model: n_batch       = 128
0.00.156.025 I llama_new_context_with_model: n_ubatch      = 128
0.00.156.025 I llama_new_context_with_model: flash_attn    = 0
0.00.156.029 I llama_new_context_with_model: freq_base     = 10000.0
0.00.156.030 I llama_new_context_with_model: freq_scale    = 1
0.00.156.031 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.160.864 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.160.892 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.160.911 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.163.035 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.163.057 I llama_new_context_with_model: graph nodes  = 967
0.00.163.057 I llama_new_context_with_model: graph splits = 1
0.00.163.060 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.226.430 I 
0.00.226.545 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.226.554 I perplexity: tokenizing the input ..
0.00.236.147 I perplexity: tokenization took 9.588 ms
0.00.236.180 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.139.618 I perplexity: 1.90 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.143.438 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.143.480 I llama_perf_context_print:        load time =     226.07 ms
0.02.143.482 I llama_perf_context_print: prompt eval time =    1901.63 ms /   128 tokens (   14.86 ms per token,    67.31 tokens per second)
0.02.143.484 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.143.484 I llama_perf_context_print:       total time =    1917.05 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.653 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.720 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.110.509 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.110.525 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.126.479 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.501 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.502 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.502 I llama_new_context_with_model: n_batch       = 2048
0.00.126.502 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.503 I llama_new_context_with_model: flash_attn    = 0
...
0.00.195.071 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.895 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.910 I llama_new_context_with_model: graph nodes  = 967
0.00.197.911 I llama_new_context_with_model: graph splits = 1
0.00.197.914 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.268.927 I main: llama threadpool init, n_threads = 4
0.00.268.959 I 
0.00.269.055 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.269.069 I 
0.00.269.231 I sampler seed: 1234
0.00.269.251 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.269.254 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.269.255 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.269.255 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.753.958 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30577.09 tokens per second)
0.01.753.960 I llama_perf_context_print:        load time =     268.01 ms
0.01.753.962 I llama_perf_context_print: prompt eval time =      76.96 ms /     7 tokens (   10.99 ms per token,    90.95 tokens per second)
0.01.753.963 I llama_perf_context_print:        eval time =    1396.95 ms /    63 runs   (   22.17 ms per token,    45.10 tokens per second)
0.01.753.963 I llama_perf_context_print:       total time =    1485.04 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.401 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.761 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.763 I llama_model_loader: - type  f32:  194 tensors
0.00.020.764 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.765 I llama_model_loader: - type q3_K:   48 tensors
0.00.020.765 I llama_model_loader: - type q6_K:    1 tensors
0.00.065.472 I llm_load_vocab: special tokens cache size = 25
...
0.00.077.050 I llm_load_print_meta: n_embd_v_gqa     = 2048
...
0.00.077.057 I llm_load_print_meta: freq_base_train  = 10000.0
...
0.00.077.061 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.077.062 I llm_load_print_meta: model params     = 1.41 B
0.00.077.063 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.111.974 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.111.994 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.126.697 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.719 I llama_new_context_with_model: n_ctx         = 128
0.00.126.719 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.720 I llama_new_context_with_model: n_batch       = 128
0.00.126.720 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.721 I llama_new_context_with_model: flash_attn    = 0
0.00.126.724 I llama_new_context_with_model: freq_base     = 10000.0
...
0.00.131.556 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.574 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.750 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.766 I llama_new_context_with_model: graph nodes  = 967
0.00.133.767 I llama_new_context_with_model: graph splits = 1
0.00.133.769 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.177.826 I 
0.00.177.945 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.177.969 I perplexity: tokenizing the input ..
0.00.187.261 I perplexity: tokenization took 9.288 ms
0.00.187.297 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.441.360 I perplexity: 1.25 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.445.033 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.445.073 I llama_perf_context_print:        load time =     177.38 ms
0.01.445.075 I llama_perf_context_print: prompt eval time =    1252.22 ms /   128 tokens (    9.78 ms per token,   102.22 tokens per second)
0.01.445.076 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.445.077 I llama_perf_context_print:       total time =    1267.25 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.583 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.139 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.076.081 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.082 I llm_load_print_meta: model params     = 1.41 B
0.00.076.083 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.122.434 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.122.451 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.202.082 I llama_new_context_with_model: n_seq_max     = 1
0.00.202.158 I llama_new_context_with_model: n_ctx         = 2048
0.00.202.158 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.202.158 I llama_new_context_with_model: n_batch       = 2048
0.00.202.159 I llama_new_context_with_model: n_ubatch      = 512
0.00.202.159 I llama_new_context_with_model: flash_attn    = 0
0.00.202.165 I llama_new_context_with_model: freq_base     = 10000.0
0.00.202.166 I llama_new_context_with_model: freq_scale    = 1
0.00.270.212 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.270.236 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.270.268 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.272.454 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.272.477 I llama_new_context_with_model: graph nodes  = 967
0.00.272.478 I llama_new_context_with_model: graph splits = 1
0.00.272.482 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.348.139 I main: llama threadpool init, n_threads = 4
0.00.348.170 I 
0.00.348.261 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.348.261 I 
0.00.348.393 I sampler seed: 1234
0.00.348.414 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.02.057.163 I llama_perf_sampler_print:    sampling time =       2.55 ms /    71 runs   (    0.04 ms per token, 27832.22 tokens per second)
0.02.057.166 I llama_perf_context_print:        load time =     347.30 ms
0.02.057.168 I llama_perf_context_print: prompt eval time =      71.13 ms /     7 tokens (   10.16 ms per token,    98.42 tokens per second)
0.02.057.169 I llama_perf_context_print:        eval time =    1626.53 ms /    63 runs   (   25.82 ms per token,    38.73 tokens per second)
0.02.057.169 I llama_perf_context_print:       total time =    1709.03 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.325 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.767 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.020.769 I llama_model_loader: - type  f32:  194 tensors
0.00.020.770 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.770 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.771 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.075.942 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.943 I llm_load_print_meta: model params     = 1.41 B
0.00.075.944 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.122.331 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.122.348 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.201.523 I llama_new_context_with_model: n_seq_max     = 1
0.00.201.545 I llama_new_context_with_model: n_ctx         = 128
0.00.201.546 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.201.546 I llama_new_context_with_model: n_batch       = 128
0.00.201.546 I llama_new_context_with_model: n_ubatch      = 128
0.00.201.547 I llama_new_context_with_model: flash_attn    = 0
0.00.201.552 I llama_new_context_with_model: freq_base     = 10000.0
0.00.201.553 I llama_new_context_with_model: freq_scale    = 1
0.00.201.553 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.206.209 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.206.237 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.206.260 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.209.086 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.250.616 I 
0.00.250.728 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.250.748 I perplexity: tokenizing the input ..
0.00.260.259 I perplexity: tokenization took 9.508 ms
0.00.260.296 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.124.649 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.128.302 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.128.340 I llama_perf_context_print:        load time =     250.25 ms
0.01.128.342 I llama_perf_context_print: prompt eval time =     862.62 ms /   128 tokens (    6.74 ms per token,   148.39 tokens per second)
0.01.128.343 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.128.343 I llama_perf_context_print:       total time =     877.72 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.658 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.421 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.132.732 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.749 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.248.906 I llama_new_context_with_model: n_seq_max     = 1
0.00.248.945 I llama_new_context_with_model: n_ctx         = 2048
0.00.248.952 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.248.959 I llama_new_context_with_model: n_batch       = 2048
0.00.248.965 I llama_new_context_with_model: n_ubatch      = 512
0.00.248.972 I llama_new_context_with_model: flash_attn    = 0
0.00.248.983 I llama_new_context_with_model: freq_base     = 10000.0
0.00.248.991 I llama_new_context_with_model: freq_scale    = 1
0.00.317.454 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.317.500 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.317.540 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.320.414 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.320.452 I llama_new_context_with_model: graph nodes  = 967
0.00.320.459 I llama_new_context_with_model: graph splits = 1
0.00.320.470 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.405.838 I main: llama threadpool init, n_threads = 4
0.00.405.871 I 
0.00.405.959 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.405.973 I 
0.00.406.110 I sampler seed: 1234
0.00.406.130 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.406.133 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.406.134 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.406.134 I 
...
0.02.370.428 I llama_perf_sampler_print:    sampling time =       2.72 ms /    71 runs   (    0.04 ms per token, 26093.35 tokens per second)
0.02.370.432 I llama_perf_context_print:        load time =     404.91 ms
0.02.370.434 I llama_perf_context_print: prompt eval time =      61.29 ms /     7 tokens (    8.76 ms per token,   114.22 tokens per second)
0.02.370.436 I llama_perf_context_print:        eval time =    1891.32 ms /    63 runs   (   30.02 ms per token,    33.31 tokens per second)
0.02.370.436 I llama_perf_context_print:       total time =    1964.60 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.616 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.800 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.074.801 I llm_load_print_meta: model params     = 1.41 B
0.00.074.802 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.130.010 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.130.025 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
...
0.00.246.722 I llama_new_context_with_model: freq_base     = 10000.0
0.00.246.731 I llama_new_context_with_model: freq_scale    = 1
0.00.246.738 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.251.574 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.251.614 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.251.645 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.253.855 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.253.888 I llama_new_context_with_model: graph nodes  = 967
0.00.253.895 I llama_new_context_with_model: graph splits = 1
0.00.253.904 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.313.491 I 
0.00.313.608 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.313.632 I perplexity: tokenizing the input ..
0.00.323.224 I perplexity: tokenization took 9.588 ms
0.00.323.260 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.874.164 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.00.877.714 I Final estimate: PPL = 10.4776 +/- 3.36742

0.00.877.755 I llama_perf_context_print:        load time =     312.84 ms
0.00.877.758 I llama_perf_context_print: prompt eval time =     549.10 ms /   128 tokens (    4.29 ms per token,   233.11 tokens per second)
0.00.877.759 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.877.760 I llama_perf_context_print:       total time =     564.26 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.608 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.678 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.140.982 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.141.001 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.268.883 I llama_new_context_with_model: n_seq_max     = 1
0.00.268.906 I llama_new_context_with_model: n_ctx         = 2048
0.00.268.907 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.268.907 I llama_new_context_with_model: n_batch       = 2048
0.00.268.907 I llama_new_context_with_model: n_ubatch      = 512
0.00.268.908 I llama_new_context_with_model: flash_attn    = 0
0.00.268.913 I llama_new_context_with_model: freq_base     = 10000.0
0.00.268.914 I llama_new_context_with_model: freq_scale    = 1
0.00.339.436 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.339.468 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.339.504 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.341.870 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.341.885 I llama_new_context_with_model: graph nodes  = 967
0.00.341.885 I llama_new_context_with_model: graph splits = 1
0.00.341.889 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.439.137 I main: llama threadpool init, n_threads = 4
0.00.439.170 I 
0.00.439.256 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.439.273 I 
0.00.439.413 I sampler seed: 1234
0.00.439.433 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.439.436 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.439.437 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.439.437 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.02.828.534 I llama_perf_sampler_print:    sampling time =       2.59 ms /    71 runs   (    0.04 ms per token, 27423.72 tokens per second)
0.02.828.536 I llama_perf_context_print:        load time =     438.24 ms
0.02.828.538 I llama_perf_context_print: prompt eval time =      83.33 ms /     7 tokens (   11.90 ms per token,    84.00 tokens per second)
0.02.828.539 I llama_perf_context_print:        eval time =    2294.50 ms /    63 runs   (   36.42 ms per token,    27.46 tokens per second)
0.02.828.539 I llama_perf_context_print:       total time =    2389.40 ms /    70 tokens
...
0.00.020.690 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.020.692 I llama_model_loader: - type  f32:  194 tensors
0.00.020.693 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.693 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.139.118 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.139.134 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.267.644 I llama_new_context_with_model: n_seq_max     = 1
0.00.267.668 I llama_new_context_with_model: n_ctx         = 128
0.00.267.668 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.267.668 I llama_new_context_with_model: n_batch       = 128
0.00.267.669 I llama_new_context_with_model: n_ubatch      = 128
0.00.267.669 I llama_new_context_with_model: flash_attn    = 0
0.00.267.675 I llama_new_context_with_model: freq_base     = 10000.0
0.00.267.676 I llama_new_context_with_model: freq_scale    = 1
0.00.267.677 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.272.417 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.272.444 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.272.470 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.274.701 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.274.717 I llama_new_context_with_model: graph nodes  = 967
0.00.274.717 I llama_new_context_with_model: graph splits = 1
0.00.274.720 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.351.129 I 
0.00.351.241 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.351.261 I perplexity: tokenizing the input ..
0.00.360.943 I perplexity: tokenization took 9.678 ms
0.00.360.978 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.001.352 I perplexity: 0.64 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.005.241 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.005.280 I llama_perf_context_print:        load time =     350.77 ms
0.01.005.282 I llama_perf_context_print: prompt eval time =     638.57 ms /   128 tokens (    4.99 ms per token,   200.45 tokens per second)
0.01.005.283 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.005.284 I llama_perf_context_print:       total time =     654.15 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.681 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.706 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.020.709 I llama_model_loader: - type  f32:  194 tensors
0.00.020.709 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.145.259 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.145.276 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.279.999 I llama_new_context_with_model: n_seq_max     = 1
0.00.280.023 I llama_new_context_with_model: n_ctx         = 2048
0.00.280.023 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.280.024 I llama_new_context_with_model: n_batch       = 2048
0.00.280.024 I llama_new_context_with_model: n_ubatch      = 512
0.00.280.025 I llama_new_context_with_model: flash_attn    = 0
0.00.280.030 I llama_new_context_with_model: freq_base     = 10000.0
0.00.280.031 I llama_new_context_with_model: freq_scale    = 1
0.00.349.734 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.349.764 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.349.798 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.352.039 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.352.060 I llama_new_context_with_model: graph nodes  = 967
0.00.352.061 I llama_new_context_with_model: graph splits = 1
0.00.352.066 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.497.167 I main: llama threadpool init, n_threads = 4
0.00.497.199 I 
0.00.497.286 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.497.286 I 
0.00.497.423 I sampler seed: 1234
...
0.00.497.449 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.497.449 I 
...
0.03.006.800 I llama_perf_sampler_print:    sampling time =       2.54 ms /    71 runs   (    0.04 ms per token, 27941.76 tokens per second)
0.03.006.803 I llama_perf_context_print:        load time =     496.22 ms
0.03.006.804 I llama_perf_context_print: prompt eval time =     107.45 ms /     7 tokens (   15.35 ms per token,    65.15 tokens per second)
0.03.006.806 I llama_perf_context_print:        eval time =    2390.66 ms /    63 runs   (   37.95 ms per token,    26.35 tokens per second)
0.03.006.806 I llama_perf_context_print:       total time =    2509.64 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.774 I build: 4312 (dc5301d5) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.954 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.075.949 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.146.292 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.146.310 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.277.733 I llama_new_context_with_model: n_seq_max     = 1
0.00.277.772 I llama_new_context_with_model: n_ctx         = 128
0.00.277.780 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.277.786 I llama_new_context_with_model: n_batch       = 128
0.00.277.792 I llama_new_context_with_model: n_ubatch      = 128
0.00.277.799 I llama_new_context_with_model: flash_attn    = 0
0.00.277.810 I llama_new_context_with_model: freq_base     = 10000.0
0.00.277.818 I llama_new_context_with_model: freq_scale    = 1
0.00.277.825 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.282.688 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.282.729 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.282.762 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.285.045 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.285.077 I llama_new_context_with_model: graph nodes  = 967
0.00.285.084 I llama_new_context_with_model: graph splits = 1
0.00.285.093 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.373.696 I 
...
0.00.373.841 I perplexity: tokenizing the input ..
0.00.383.440 I perplexity: tokenization took 9.596 ms
0.00.383.476 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.161.765 I perplexity: 0.78 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.165.614 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.165.657 I llama_perf_context_print:        load time =     372.88 ms
0.01.165.686 I llama_perf_context_print: prompt eval time =     776.41 ms /   128 tokens (    6.07 ms per token,   164.86 tokens per second)
0.01.165.713 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.165.714 I llama_perf_context_print:       total time =     791.96 ms /   129 tokens
...
0.00.299.708 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.300.742 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
