...
- status:  SUCCESS ✅
- runtime: 476.35
- date:    Sat May 25 12:09:34 EEST 2024
...
llama_print_timings:        load time =      65.31 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       9.02 ms /     9 tokens (    1.00 ms per token,   998.34 tokens per second)
