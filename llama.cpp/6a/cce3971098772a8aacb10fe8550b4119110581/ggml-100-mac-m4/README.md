...
- status:  SUCCESS ✅
- runtime: 814.13
- date:    Sun Dec  1 01:32:07 PST 2024
...
0.00.103.517 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.150.783 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.058.765 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.095.103 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.033.395 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.062.481 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.056.828 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.044.309 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.024.036 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.023.378 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.048.901 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.036.430 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.064.794 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.057.366 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.983 I llm_load_print_meta: LF token         = 128 'Ä'
