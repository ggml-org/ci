...
- status:  SUCCESS ✅
- runtime: 478.67
- date:    Sun May 19 15:52:15 EEST 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/6aade19ee74b896c59929676629340b36be3e22c
- author:  Anas Ahouzi
```
...
Label Time Summary:
main    = 183.29 sec*proc (22 tests)

Total Test time (real) = 183.30 sec
...
llama_print_timings:        load time =      69.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.08 ms /     9 tokens (    1.34 ms per token,   745.28 tokens per second)
