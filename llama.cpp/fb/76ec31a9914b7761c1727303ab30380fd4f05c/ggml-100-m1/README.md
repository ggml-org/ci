...
- status:  SUCCESS ✅
- runtime: 318.45
- date:    Wed May 29 20:22:06 EEST 2024
...
llama_print_timings:       total time =       9.93 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.17 ms /     9 tokens (    1.35 ms per token,   739.46 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
