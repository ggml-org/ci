...
- status:  SUCCESS ✅
- runtime: 560.36
- date:    Sat Mar  9 14:33:31 EET 2024
...
llama_print_timings: prompt eval time =      12.19 ms /     9 tokens (    1.35 ms per token,   738.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      37.02 ms /    10 tokens
