...
- status:  SUCCESS ✅
- runtime: 824.56
- date:    Wed Dec 18 04:21:31 PST 2024
...
0.00.063.921 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.101.840 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.736 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.085.227 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.059.080 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.054.006 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.650 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.092.469 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.052.226 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.033.775 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.042.380 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.054.415 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.049.875 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.053.763 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.034.549 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.051.367 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.053.221 I llm_load_print_meta: LF token         = 128 'Ä'
