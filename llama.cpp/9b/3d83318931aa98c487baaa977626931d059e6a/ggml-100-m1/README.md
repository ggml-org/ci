...
- status:  SUCCESS ✅
- runtime: 338.07
- date:    Wed May 22 12:41:48 EEST 2024
...
Label Time Summary:
main    = 182.57 sec*proc (22 tests)

Total Test time (real) = 182.58 sec
...
llama_print_timings:        load time =      63.60 ms
...
llama_print_timings:        load time =      51.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.82 ms /     9 tokens (    1.20 ms per token,   832.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
