...
- status:  SUCCESS ✅
- runtime: 489.05
- date:    Sun Apr 21 15:38:38 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.53 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 196.39 sec*proc (23 tests)

Total Test time (real) = 196.40 sec
...
llama_print_timings: prompt eval time =      12.26 ms /     9 tokens (    1.36 ms per token,   734.33 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.42 ms /     9 tokens (    1.49 ms per token,   670.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
After-sales service is crucial for businesses to ensure customer satisfaction and loyalty. It encompasses all interactions and support provided to customers
llama_print_timings:        load time =    3048.14 ms
llama_print_timings:      sample time =      56.90 ms /    32 runs   (    1.78 ms per token,   562.39 tokens per second)
...
llama_print_timings:       total time =    2515.90 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
Heals is a non-profit organization dedicated to empowering individuals and communities to heal and thrive. They offer a variety of programs and resources, including:
llama_print_timings:        load time =    3289.78 ms
llama_print_timings:      sample time =      56.31 ms /    32 runs   (    1.76 ms per token,   568.28 tokens per second)
llama_print_timings: prompt eval time =     202.45 ms /     2 tokens (  101.22 ms per token,     9.88 tokens per second)
llama_print_timings:        eval time =    1498.03 ms /    31 runs   (   48.32 ms per token,    20.69 tokens per second)
llama_print_timings:       total time =    2501.23 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekher's rise and fall: A cautionary tale of ambition and corruption

**Introduction:**

Shekher Singh Gill, better known as Shek
llama_print_timings:        load time =    3078.27 ms
llama_print_timings:      sample time =      57.39 ms /    32 runs   (    1.79 ms per token,   557.56 tokens per second)
llama_print_timings: prompt eval time =     197.88 ms /     2 tokens (   98.94 ms per token,    10.11 tokens per second)
llama_print_timings:        eval time =    1503.15 ms /    31 runs   (   48.49 ms per token,    20.62 tokens per second)
llama_print_timings:       total time =    2563.63 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekera is a well-known figure in the field of _______.
...
The
llama_print_timings:        load time =    2300.84 ms
llama_print_timings:      sample time =      16.53 ms /    32 runs   (    0.52 ms per token,  1936.11 tokens per second)
llama_print_timings: prompt eval time =     194.66 ms /     2 tokens (   97.33 ms per token,    10.27 tokens per second)
...
llama_print_timings:        load time =    3536.30 ms
llama_print_timings:      sample time =      16.36 ms /    32 runs   (    0.51 ms per token,  1956.35 tokens per second)
llama_print_timings: prompt eval time =     200.77 ms /     2 tokens (  100.39 ms per token,     9.96 tokens per second)
llama_print_timings:        eval time =    1520.11 ms /    31 runs   (   49.04 ms per token,    20.39 tokens per second)
llama_print_timings:       total time =    1812.71 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Soar is a global, mission-driven company that empowers people to achieve their full potential through personalized coaching and development.

**Our Vision:** To unlock the full
llama_print_timings:        load time =    3141.14 ms
llama_print_timings:      sample time =      16.75 ms /    32 runs   (    0.52 ms per token,  1910.56 tokens per second)
llama_print_timings: prompt eval time =     196.12 ms /     2 tokens (   98.06 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1530.03 ms /    31 runs   (   49.36 ms per token,    20.26 tokens per second)
