...
- status:  SUCCESS ✅
- runtime: 510.20
- date:    Mon Mar  4 13:51:15 EET 2024
...
Label Time Summary:
main    = 228.87 sec*proc (21 tests)

Total Test time (real) = 228.88 sec
...
llama_print_timings:        load time =      51.03 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.27 ms /     9 tokens (    1.25 ms per token,   798.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
