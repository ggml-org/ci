...
- status:  SUCCESS ✅
- runtime: 340.31
- date:    Wed May 22 11:29:15 EEST 2024
...
llama_print_timings: prompt eval time =      12.02 ms /     9 tokens (    1.34 ms per token,   748.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      12.79 ms /    10 tokens
