...
- status:  SUCCESS ✅
- runtime: 15:51.08
- date:    Tue Apr 30 08:37:47 UTC 2024
...
12/21 Test #12: test-quantize-perf ................   Passed   10.48 sec
...
Test project /home/ggml/work/llama.cpp/build-ci-release
 ...
 6/21 Test  #6: test-tokenizer-0-deepseek-coder ...   Passed    0.18 sec
      Start  7: test-tokenizer-0-bert-bge
 7/21 Test  #7: test-tokenizer-0-bert-bge .........   Passed    0.14 sec
      Start  8: test-tokenizer-0-starcoder
...
llama_print_timings:        load time =      39.12 ms
...
llama_print_timings:       total time =      79.28 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       9.25 ms /     9 tokens (    1.03 ms per token,   973.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      77.69 ms /    10 tokens
...
<bos> When the speaker says "I don't recall that," what does it imply about their memory?

**A)** The speaker is able to recall most memories.
llama_print_timings:        load time =    1183.14 ms
llama_print_timings:      sample time =       8.46 ms /    32 runs   (    0.26 ms per token,  3780.27 tokens per second)
...
llama_print_timings:       total time =    3322.01 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, and this holds true for many things in life, including relationships.

**Discuss the different ways opposites attract in relationships.**

**1.
llama_print_timings:        load time =    1169.99 ms
llama_print_timings:      sample time =       7.85 ms /    32 runs   (    0.25 ms per token,  4078.51 tokens per second)
llama_print_timings: prompt eval time =     165.60 ms /     2 tokens (   82.80 ms per token,    12.08 tokens per second)
llama_print_timings:        eval time =    3116.43 ms /    31 runs   (  100.53 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3322.39 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When Life Gives You Lemons, Make Lemonade!

This slogan encourages optimism and resilience in the face of adversity. It suggests that challenges and setbacks are opportunities for personal
llama_print_timings:        load time =    1171.52 ms
llama_print_timings:      sample time =       8.02 ms /    32 runs   (    0.25 ms per token,  3989.03 tokens per second)
llama_print_timings: prompt eval time =     164.66 ms /     2 tokens (   82.33 ms per token,    12.15 tokens per second)
llama_print_timings:        eval time =    3105.58 ms /    31 runs   (  100.18 ms per token,     9.98 tokens per second)
llama_print_timings:       total time =    3310.60 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26702.65 ms
main:    total time = 26702.65 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar is an AI-powered platform that uses machine learning to provide personalized career coaching and career exploration. It uses a quiz-based approach, personality assessments, and
llama_print_timings:        load time =     755.46 ms
llama_print_timings:      sample time =       7.79 ms /    32 runs   (    0.24 ms per token,  4105.20 tokens per second)
llama_print_timings: prompt eval time =     155.46 ms /     2 tokens (   77.73 ms per token,    12.87 tokens per second)
llama_print_timings:        eval time =    2937.35 ms /    31 runs   (   94.75 ms per token,    10.55 tokens per second)
llama_print_timings:       total time =    3133.41 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26848.92 ms
main:    total time = 26848.92 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a young girl named Alice who lived in a small village. She was known for her bright smile, infectious laughter, and a heart filled with kindness
llama_print_timings:        load time =     760.28 ms
llama_print_timings:      sample time =       7.65 ms /    32 runs   (    0.24 ms per token,  4183.55 tokens per second)
llama_print_timings: prompt eval time =     339.67 ms /     5 tokens (   67.93 ms per token,    14.72 tokens per second)
llama_print_timings:        eval time =    2913.56 ms /    31 runs   (   93.99 ms per token,    10.64 tokens per second)
llama_print_timings:       total time =    3293.09 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    2754.35 ms
llama_print_timings:      sample time =       2.59 ms /    64 runs   (    0.04 ms per token, 24672.32 tokens per second)
llama_print_timings: prompt eval time =    1118.85 ms /     8 tokens (  139.86 ms per token,     7.15 tokens per second)
llama_print_timings:        eval time =   14087.93 ms /    63 runs   (  223.62 ms per token,     4.47 tokens per second)
llama_print_timings:       total time =   15220.55 ms /    71 tokens
Log end
...
[1]4.2449,
llama_print_timings:        load time =    2735.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22169.80 ms /   128 tokens (  173.20 ms per token,     5.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22182.13 ms /   129 tokens
...
llama_print_timings:        load time =    1584.13 ms
llama_print_timings:      sample time =       2.62 ms /    64 runs   (    0.04 ms per token, 24436.81 tokens per second)
llama_print_timings: prompt eval time =     883.76 ms /     8 tokens (  110.47 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =    8413.82 ms /    63 runs   (  133.55 ms per token,     7.49 tokens per second)
llama_print_timings:       total time =    9313.95 ms /    71 tokens
Log end
...
llama_print_timings: prompt eval time =     904.77 ms /     8 tokens (  113.10 ms per token,     8.84 tokens per second)
llama_print_timings:        eval time =    7914.27 ms /    63 runs   (  125.62 ms per token,     7.96 tokens per second)
llama_print_timings:       total time =    8833.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14907.75 ms /   128 tokens (  116.47 ms per token,     8.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14919.68 ms /   129 tokens
...
llama_print_timings:        load time =    1109.71 ms
...
llama_print_timings:        eval time =    8388.23 ms /    63 runs   (  133.15 ms per token,     7.51 tokens per second)
llama_print_timings:       total time =    9361.84 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15825.35 ms /   128 tokens (  123.64 ms per token,     8.09 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15837.30 ms /   129 tokens
...
llama_print_timings:        eval time =   10501.98 ms /    63 runs   (  166.70 ms per token,     6.00 tokens per second)
llama_print_timings:       total time =   11725.00 ms /    71 tokens
Log end
...
[1]4.3235,
llama_print_timings:        load time =    1170.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20042.92 ms /   128 tokens (  156.59 ms per token,     6.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20055.20 ms /   129 tokens
...
I believe
llama_print_timings:        load time =    1337.94 ms
llama_print_timings:      sample time =       2.66 ms /    64 runs   (    0.04 ms per token, 24060.15 tokens per second)
llama_print_timings: prompt eval time =    1234.56 ms /     8 tokens (  154.32 ms per token,     6.48 tokens per second)
llama_print_timings:        eval time =   10993.99 ms /    63 runs   (  174.51 ms per token,     5.73 tokens per second)
llama_print_timings:       total time =   12242.65 ms /    71 tokens
Log end
...
[1]4.2508,
llama_print_timings:        load time =    1252.79 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20122.93 ms /   128 tokens (  157.21 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20134.29 ms /   129 tokens
...
llama_print_timings:        load time =     855.11 ms
...
llama_print_timings:        eval time =    9784.92 ms /    63 runs   (  155.32 ms per token,     6.44 tokens per second)
llama_print_timings:       total time =   10948.02 ms /    71 tokens
Log end
...
[1]5.6277,
llama_print_timings:        load time =     855.68 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18721.81 ms /   128 tokens (  146.26 ms per token,     6.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18733.70 ms /   129 tokens
...
llama_print_timings:        load time =     950.37 ms
llama_print_timings:      sample time =       2.71 ms /    64 runs   (    0.04 ms per token, 23633.68 tokens per second)
llama_print_timings: prompt eval time =    1080.13 ms /     8 tokens (  135.02 ms per token,     7.41 tokens per second)
llama_print_timings:        eval time =    9347.90 ms /    63 runs   (  148.38 ms per token,     6.74 tokens per second)
llama_print_timings:       total time =   10441.69 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17747.14 ms /   128 tokens (  138.65 ms per token,     7.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17759.19 ms /   129 tokens
...
llama_print_timings:        load time =    1133.09 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23907.36 tokens per second)
llama_print_timings: prompt eval time =     951.05 ms /     8 tokens (  118.88 ms per token,     8.41 tokens per second)
llama_print_timings:        eval time =    8350.50 ms /    63 runs   (  132.55 ms per token,     7.54 tokens per second)
llama_print_timings:       total time =    9314.93 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15615.30 ms /   128 tokens (  121.99 ms per token,     8.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15627.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1310.55 ms /     8 tokens (  163.82 ms per token,     6.10 tokens per second)
llama_print_timings:        eval time =   11168.87 ms /    63 runs   (  177.28 ms per token,     5.64 tokens per second)
llama_print_timings:       total time =   12493.57 ms /    71 tokens
Log end
...
[1]4.2277,
llama_print_timings:        load time =    1257.31 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21444.42 ms /   128 tokens (  167.53 ms per token,     5.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
I
llama_print_timings:        load time =    1408.31 ms
llama_print_timings:      sample time =       2.71 ms /    64 runs   (    0.04 ms per token, 23633.68 tokens per second)
llama_print_timings: prompt eval time =    1340.78 ms /     8 tokens (  167.60 ms per token,     5.97 tokens per second)
llama_print_timings:        eval time =   11477.31 ms /    63 runs   (  182.18 ms per token,     5.49 tokens per second)
llama_print_timings:       total time =   12838.17 ms /    71 tokens
Log end
...
[1]4.2538,
llama_print_timings:        load time =    1450.41 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21923.92 ms /   128 tokens (  171.28 ms per token,     5.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21936.26 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog, was a very powerful observation made by Lewis Carroll in


second run: The quick brown fox jumps over the lazy dog, was a very powerful observation made by Lewis Carroll in


single seq run: The quick brown fox jumps over the lazy dog, was a very powerful observation made by Lewis Carroll in
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 66.675 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 22.25 seconds per pass - ETA 0.37 minutes
[1]9.1008,
llama_print_timings:        load time =    2952.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22254.98 ms /   128 tokens (  173.87 ms per token,     5.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22323.29 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.243 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 21.92 seconds per pass - ETA 0.35 minutes
[1]7.0171,
llama_print_timings:        load time =    6837.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21921.09 ms /   128 tokens (  171.26 ms per token,     5.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21983.20 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.165 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.32 seconds per pass - ETA 0.23 minutes
[1]9.1403,
llama_print_timings:        load time =    1640.11 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14319.72 ms /   128 tokens (  111.87 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14386.88 ms /   129 tokens
...
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]6.9493,
llama_print_timings:        load time =    5428.04 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14312.02 ms /   128 tokens (  111.81 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14375.39 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 63.349 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]7.0116,
llama_print_timings:        load time =    6062.07 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14313.62 ms /   128 tokens (  111.83 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14378.46 ms /   129 tokens
...
0.37user 2.92system 0:03.29elapsed 100%CPU (0avgtext+0avgdata 6878008maxresident)k
...
0.12user 2.91system 0:03.04elapsed 100%CPU (0avgtext+0avgdata 6877424maxresident)k
