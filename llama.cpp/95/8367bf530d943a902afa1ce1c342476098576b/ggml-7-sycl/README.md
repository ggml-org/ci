...
- status:  FAILURE ❌ (8)
- runtime: 1:31.47
- date:    Thu Oct 24 19:53:08 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/958367bf530d943a902afa1ce1c342476098576b
...
Test project /home/devcloud/work/llama.cpp/build-ci-debug
 ...
 6/28 Test  #6: test-tokenizer-0-gpt-2 ............   Passed    0.40 sec
...
14/28 Test #14: test-tokenizer-1-llama-spm ........   Passed    0.74 sec
      Start 15: test-log
15/28 Test #15: test-log ..........................   Passed    0.11 sec
      Start 16: test-arg-parser
16/28 Test #16: test-arg-parser ...................   Passed    0.17 sec
      Start 17: test-quantize-fns
17/28 Test #17: test-quantize-fns .................   Passed   17.75 sec
      Start 18: test-quantize-perf
18/28 Test #18: test-quantize-perf ................   Passed    5.36 sec
      Start 19: test-sampling
19/28 Test #19: test-sampling .....................   Passed    3.88 sec
      Start 20: test-chat-template
20/28 Test #20: test-chat-template ................   Passed    0.07 sec
      Start 21: test-grammar-parser
21/28 Test #21: test-grammar-parser ...............   Passed    0.08 sec
      Start 22: test-llama-grammar
22/28 Test #22: test-llama-grammar ................   Passed    0.08 sec
      Start 23: test-grammar-integration
23/28 Test #23: test-grammar-integration ..........   Passed    0.10 sec
      Start 24: test-grad0
24/28 Test #24: test-grad0 ........................   Passed    3.28 sec
      Start 25: test-barrier
25/28 Test #25: test-barrier ......................   Passed    5.32 sec
      Start 26: test-backend-ops
26/28 Test #26: test-backend-ops ..................Subprocess aborted***Exception:   8.54 sec
...
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [464,0,0], local id: [0,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [465,0,0], local id: [1,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [466,0,0], local id: [2,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [467,0,0], local id: [3,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [468,0,0], local id: [4,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [469,0,0], local id: [5,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [470,0,0], local id: [6,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [471,0,0], local id: [7,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [472,0,0], local id: [8,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [473,0,0], local id: [9,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [474,0,0], local id: [10,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [475,0,0], local id: [11,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [476,0,0], local id: [12,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [477,0,0], local id: [13,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [478,0,0], local id: [14,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.
norm.cpp:11: void norm_f32(const float *, float *, const int, const float, const sycl::nd_item<3> &, sycl::float2 *, int): global id: [479,0,0], local id: [15,0,0] Assertion `nwarps % WARP_SIZE == 0` failed.

      Start 27: test-rope
27/28 Test #27: test-rope .........................   Passed    0.17 sec
...
Label Time Summary:
main    =  55.76 sec*proc (28 tests)

Total Test time (real) =  55.78 sec
