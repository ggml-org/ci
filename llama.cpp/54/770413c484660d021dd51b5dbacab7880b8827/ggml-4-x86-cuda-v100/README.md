...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Thu Apr 25 12:58:35 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   36.28 sec
...
13/23 Test #13: test-tokenizer-1-gpt-neox ...........   Passed    7.49 sec
...
21/23 Test #21: test-backend-ops ....................   Passed  125.14 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 248.82 sec*proc (23 tests)

Total Test time (real) = 249.09 sec
...
20/23 Test #20: test-grad0 ..........................   Passed    4.27 sec
      Start 21: test-backend-ops
21/23 Test #21: test-backend-ops ....................   Passed   38.97 sec
      Start 22: test-rope
...
llama_print_timings:        load time =     429.60 ms
...
ggml_gallocr_alloc_graph: cannot reallocate multi buffer graph automatically, call reserve
ggml_backend_sched_alloc_splits: failed to allocate graph, reserving
, in a quaint village nestled amidst rolling hills, there lived a wise and humble blacksmith named Bartholomew.

Bartholomew's days were filled with the
llama_print_timings:        load time =    3973.16 ms
llama_print_timings:      sample time =      52.56 ms /    32 runs   (    1.64 ms per token,   608.80 tokens per second)
llama_print_timings: prompt eval time =    8444.31 ms /     5 tokens ( 1688.86 ms per token,     0.59 tokens per second)
llama_print_timings:        eval time =   64803.12 ms /    31 runs   ( 2090.42 ms per token,     0.48 tokens per second)
llama_print_timings:       total time =   73493.63 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heuristics is a cognitive bias that leads people to make decisions based on their first impressions and heuristics, rather than careful analysis.

**a) True**

llama_print_timings:        load time =    4466.52 ms
llama_print_timings:      sample time =      52.78 ms /    32 runs   (    1.65 ms per token,   606.34 tokens per second)
llama_print_timings: prompt eval time =    3603.26 ms /     2 tokens ( 1801.63 ms per token,     0.56 tokens per second)
llama_print_timings:        eval time =   64042.19 ms /    31 runs   ( 2065.88 ms per token,     0.48 tokens per second)
llama_print_timings:       total time =   67884.21 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heers is a financial services technology company dedicated to simplifying access to personal financial management tools and services. Heers utilizes an AI-powered platform that analyzes personal financial data
llama_print_timings:        load time =    3933.65 ms
llama_print_timings:      sample time =      52.21 ms /    32 runs   (    1.63 ms per token,   612.90 tokens per second)
llama_print_timings: prompt eval time =    3385.64 ms /     2 tokens ( 1692.82 ms per token,     0.59 tokens per second)
llama_print_timings:        eval time =   64350.93 ms /    31 runs   ( 2075.84 ms per token,     0.48 tokens per second)
llama_print_timings:       total time =   67995.30 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 226635.47 ms
main:    total time = 226635.47 ms
+ echo PASS
PASS
+ echo
...
<bos> After the earthquake, many people lost their homes and belongings. They were left with nothing but the clothes on their backs. How can we support them?

**Here
llama_print_timings:        load time =    1792.76 ms
llama_print_timings:      sample time =      52.23 ms /    32 runs   (    1.63 ms per token,   612.69 tokens per second)
llama_print_timings: prompt eval time =    1334.76 ms /     2 tokens (  667.38 ms per token,     1.50 tokens per second)
llama_print_timings:        eval time =   22450.10 ms /    31 runs   (  724.20 ms per token,     1.38 tokens per second)
llama_print_timings:       total time =   24027.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 226044.03 ms
main:    total time = 226044.03 ms
+ echo PASS
PASS
+ echo
...
<bos> When I die, who will know my story?

The answer is no one.

When someone dies, their story ceases to exist. There is no one to
llama_print_timings:        load time =    1721.38 ms
llama_print_timings:      sample time =      53.52 ms /    32 runs   (    1.67 ms per token,   597.92 tokens per second)
llama_print_timings: prompt eval time =    1176.44 ms /     2 tokens (  588.22 ms per token,     1.70 tokens per second)
llama_print_timings:        eval time =   22654.04 ms /    31 runs   (  730.78 ms per token,     1.37 tokens per second)
llama_print_timings:       total time =   24078.09 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say money can't buy happiness, but it can certainly buy experiences, and those experiences can bring lasting joy.

**True or False?**

The
llama_print_timings:        load time =     683.94 ms
llama_print_timings:      sample time =       5.05 ms /    32 runs   (    0.16 ms per token,  6330.37 tokens per second)
llama_print_timings: prompt eval time =     139.63 ms /     2 tokens (   69.81 ms per token,    14.32 tokens per second)
llama_print_timings:        eval time =    3787.34 ms /    31 runs   (  122.17 ms per token,     8.19 tokens per second)
llama_print_timings:       total time =    4014.57 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the only thing missing is the crown.<eos> [end of text]

llama_print_timings:        load time =     691.02 ms
llama_print_timings:      sample time =       1.94 ms /    10 runs   (    0.19 ms per token,  5159.96 tokens per second)
llama_print_timings: prompt eval time =     139.06 ms /     2 tokens (   69.53 ms per token,    14.38 tokens per second)
llama_print_timings:        eval time =    1216.18 ms /     9 runs   (  135.13 ms per token,     7.40 tokens per second)
llama_print_timings:       total time =    1394.74 ms /    11 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekera Foundation is a nonprofit organization dedicated to promoting social justice, equity, and inclusion. It provides resources and support to individuals and organizations working to create positive change
llama_print_timings:        load time =     706.76 ms
...
llama_print_timings:        eval time =    4228.69 ms /    31 runs   (  136.41 ms per token,     7.33 tokens per second)
llama_print_timings:       total time =    4533.87 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 42806.30 ms
main:    total time = 42806.30 ms
+ echo PASS
PASS
+ echo
...
<bos> Shewans are a family of people who live in the United States and have a unique heritage that includes their ancestral knowledge, storytelling, and traditions.
...
llama_print_timings: prompt eval time =     126.62 ms /     2 tokens (   63.31 ms per token,    15.80 tokens per second)
llama_print_timings:        eval time =    2601.88 ms /    31 runs   (   83.93 ms per token,    11.91 tokens per second)
llama_print_timings:       total time =    2860.02 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 41797.01 ms
main:    total time = 41797.01 ms
+ echo PASS
PASS
+ echo
...
<bos> After successfully implementing a new customer relationship management (CRM) system, the company faced a surge in customer inquiries and pressure on their support team.

**Solution:** Implement
llama_print_timings:        load time =     654.90 ms
llama_print_timings:      sample time =       5.39 ms /    32 runs   (    0.17 ms per token,  5938.02 tokens per second)
llama_print_timings: prompt eval time =     145.99 ms /     2 tokens (   72.99 ms per token,    13.70 tokens per second)
llama_print_timings:        eval time =    2726.72 ms /    31 runs   (   87.96 ms per token,    11.37 tokens per second)
llama_print_timings:       total time =    2965.82 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
