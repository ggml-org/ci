...
- status:  SUCCESS ✅
- runtime: 3345.10
- date:    Thu Apr 25 15:26:56 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.83 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 196.73 sec*proc (23 tests)

Total Test time (real) = 196.74 sec
...
20/23 Test #20: test-grad0 ..........................   Passed    0.83 sec
      Start 21: test-backend-ops
21/23 Test #21: test-backend-ops ....................   Passed   28.22 sec
      Start 22: test-rope
...
llama_print_timings:        load time =      67.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.77 ms /     9 tokens (    1.31 ms per token,   764.53 tokens per second)
...
llama_print_timings:        load time =      52.56 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.53 ms /     9 tokens (    1.50 ms per token,   665.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> The Witcher Season 2 has just concluded, and fans are eager to know what happens next.

**Here are some questions circulating in the fandom:**

**1
llama_print_timings:        load time =    2618.21 ms
llama_print_timings:      sample time =      59.64 ms /    32 runs   (    1.86 ms per token,   536.59 tokens per second)
llama_print_timings: prompt eval time =     195.96 ms /     2 tokens (   97.98 ms per token,    10.21 tokens per second)
llama_print_timings:        eval time =    1501.00 ms /    31 runs   (   48.42 ms per token,    20.65 tokens per second)
llama_print_timings:       total time =    2613.76 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, in a bustling city, there lived a young woman named Anya. Driven by ambition, she had set her sights on a career in fashion design.

A
llama_print_timings:        load time =    3330.70 ms
llama_print_timings:      sample time =      55.80 ms /    32 runs   (    1.74 ms per token,   573.53 tokens per second)
llama_print_timings: prompt eval time =     206.79 ms /     5 tokens (   41.36 ms per token,    24.18 tokens per second)
llama_print_timings:        eval time =    1505.31 ms /    31 runs   (   48.56 ms per token,    20.59 tokens per second)
llama_print_timings:       total time =    2527.29 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> When a battery is connected to a circuit, what determines the direction of the current flow?

**a)** The direction of the current flow is determined by the polarity
llama_print_timings:        load time =    2704.67 ms
llama_print_timings:      sample time =      56.60 ms /    32 runs   (    1.77 ms per token,   565.36 tokens per second)
llama_print_timings: prompt eval time =     196.35 ms /     2 tokens (   98.17 ms per token,    10.19 tokens per second)
llama_print_timings:        eval time =    1497.99 ms /    31 runs   (   48.32 ms per token,    20.69 tokens per second)
llama_print_timings:       total time =    2510.88 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 196567.42 ms
main:    total time = 196567.42 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a quaint village nestled amidst rolling hills, there lived a curious little girl named Anya. Anya had bright eyes that sparkled with curiosity and a smile that
llama_print_timings:        load time =    1557.06 ms
llama_print_timings:      sample time =      45.43 ms /    32 runs   (    1.42 ms per token,   704.40 tokens per second)
llama_print_timings: prompt eval time =     216.38 ms /     5 tokens (   43.28 ms per token,    23.11 tokens per second)
llama_print_timings:        eval time =    1064.02 ms /    31 runs   (   34.32 ms per token,    29.13 tokens per second)
llama_print_timings:       total time =    1926.46 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 197558.21 ms
main:    total time = 197558.21 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    1708.07 ms
llama_print_timings:      sample time =      47.54 ms /    32 runs   (    1.49 ms per token,   673.13 tokens per second)
llama_print_timings: prompt eval time =     217.31 ms /     2 tokens (  108.66 ms per token,     9.20 tokens per second)
llama_print_timings:        eval time =    1082.15 ms /    31 runs   (   34.91 ms per token,    28.65 tokens per second)
llama_print_timings:       total time =    1973.00 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    1971.55 ms
llama_print_timings:      sample time =      16.08 ms /    32 runs   (    0.50 ms per token,  1989.55 tokens per second)
llama_print_timings: prompt eval time =     195.61 ms /     2 tokens (   97.80 ms per token,    10.22 tokens per second)
llama_print_timings:        eval time =    1524.51 ms /    31 runs   (   49.18 ms per token,    20.33 tokens per second)
llama_print_timings:       total time =    1808.77 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
**Verse 1:**
Let's spread our wings and soar high,
To reach the stars and touch the sky.
With courage
llama_print_timings:        load time =    3125.27 ms
llama_print_timings:      sample time =      16.48 ms /    32 runs   (    0.52 ms per token,  1941.63 tokens per second)
llama_print_timings: prompt eval time =     200.66 ms /     2 tokens (  100.33 ms per token,     9.97 tokens per second)
llama_print_timings:        eval time =    1525.85 ms /    31 runs   (   49.22 ms per token,    20.32 tokens per second)
llama_print_timings:       total time =    1818.63 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heidelberger Society of North America

**Our Mission:**

* To preserve and promote the heritage and traditions of the Heidelberger people.
* To foster
llama_print_timings:        load time =    2663.07 ms
llama_print_timings:      sample time =      16.52 ms /    32 runs   (    0.52 ms per token,  1937.28 tokens per second)
llama_print_timings: prompt eval time =     197.76 ms /     2 tokens (   98.88 ms per token,    10.11 tokens per second)
llama_print_timings:        eval time =    1513.39 ms /    31 runs   (   48.82 ms per token,    20.48 tokens per second)
llama_print_timings:       total time =    1803.81 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21223.90 ms
main:    total time = 21223.90 ms
+ echo PASS
PASS
+ echo
...
<bos> After using the product for a few weeks, I have noticed a significant improvement in my skin's texture and appearance. I am thrilled with the results and I feel
llama_print_timings:        load time =    1393.81 ms
llama_print_timings:      sample time =      15.43 ms /    32 runs   (    0.48 ms per token,  2074.29 tokens per second)
llama_print_timings: prompt eval time =     212.69 ms /     2 tokens (  106.34 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1087.81 ms /    31 runs   (   35.09 ms per token,    28.50 tokens per second)
llama_print_timings:       total time =    1384.94 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21521.84 ms
main:    total time = 21521.84 ms
+ echo PASS
PASS
+ echo
...
<bos> They say with age comes wisdom.
...
With age, individuals gain experience, knowledge, and
llama_print_timings:        load time =    1558.94 ms
llama_print_timings:      sample time =      16.43 ms /    32 runs   (    0.51 ms per token,  1947.06 tokens per second)
llama_print_timings: prompt eval time =     215.15 ms /     2 tokens (  107.57 ms per token,     9.30 tokens per second)
llama_print_timings:        eval time =    1102.48 ms /    31 runs   (   35.56 ms per token,    28.12 tokens per second)
llama_print_timings:       total time =    1408.98 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
