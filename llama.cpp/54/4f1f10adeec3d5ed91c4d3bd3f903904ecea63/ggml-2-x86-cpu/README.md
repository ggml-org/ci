...
- status:  SUCCESS ✅
- runtime: 11:46.42
- date:    Mon Apr 29 15:06:57 UTC 2024
...
11/21 Test #11: test-quantize-fns .................   Passed   15.93 sec
      Start 12: test-quantize-perf
12/21 Test #12: test-quantize-perf ................   Passed    4.45 sec
      Start 13: test-sampling
...
17/21 Test #17: test-grammar-integration ..........   Passed    0.00 sec
      Start 18: test-grad0
18/21 Test #18: test-grad0 ........................   Passed    2.35 sec
      Start 19: test-backend-ops
19/21 Test #19: test-backend-ops ..................   Passed    0.00 sec
      Start 20: test-rope
20/21 Test #20: test-rope .........................   Passed    0.05 sec
      Start 23: test-json-schema-to-grammar
21/21 Test #23: test-json-schema-to-grammar .......   Passed    1.39 sec

100% tests passed, 0 tests failed out of 21

Label Time Summary:
main    =  26.10 sec*proc (21 tests)
...
llama_print_timings:       total time =      54.78 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.77 ms /     9 tokens (    0.42 ms per token,  2389.17 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      51.64 ms /    10 tokens
...
<bos> If the population of the earth is approximately 8 billion people, what percentage of the population would be considered poor?

**Answer:**
The provided text does not
llama_print_timings:        load time =    1234.76 ms
llama_print_timings:      sample time =      47.71 ms /    32 runs   (    1.49 ms per token,   670.75 tokens per second)
llama_print_timings: prompt eval time =    1123.48 ms /     2 tokens (  561.74 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20935.88 ms /    31 runs   (  675.35 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22244.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After hours, I'm free and can dedicate my time to my passion project. I'm excited about the possibilities and eager to get started.

**Questions
llama_print_timings:        load time =    1237.65 ms
llama_print_timings:      sample time =      47.74 ms /    32 runs   (    1.49 ms per token,   670.23 tokens per second)
llama_print_timings: prompt eval time =    1122.17 ms /     2 tokens (  561.08 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20989.44 ms /    31 runs   (  677.08 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22294.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a brave knight named Sir Eldred.

**Describe Sir Eldred's personality and motivations.**

**Personality:**

* **Brave:**
llama_print_timings:        load time =    1214.36 ms
llama_print_timings:      sample time =      47.49 ms /    32 runs   (    1.48 ms per token,   673.76 tokens per second)
llama_print_timings: prompt eval time =    2584.72 ms /     5 tokens (  516.94 ms per token,     1.93 tokens per second)
llama_print_timings:        eval time =   20575.49 ms /    31 runs   (  663.73 ms per token,     1.51 tokens per second)
llama_print_timings:       total time =   23343.66 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
The Little Prince is a classic children's book that explores the themes of love, loss, and the importance of connection. The book tells the
llama_print_timings:        load time =     184.14 ms
llama_print_timings:      sample time =       6.79 ms /    32 runs   (    0.21 ms per token,  4712.81 tokens per second)
llama_print_timings: prompt eval time =      75.11 ms /     2 tokens (   37.56 ms per token,    26.63 tokens per second)
llama_print_timings:        eval time =    2038.64 ms /    31 runs   (   65.76 ms per token,    15.21 tokens per second)
llama_print_timings:       total time =    2181.07 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a wise woman who resided in a secluded forest.

**Task:** Write a short story based on this prompt.

The wise woman sat nestled
...
llama_print_timings: prompt eval time =     126.27 ms /     5 tokens (   25.25 ms per token,    39.60 tokens per second)
llama_print_timings:        eval time =    1962.64 ms /    31 runs   (   63.31 ms per token,    15.80 tokens per second)
llama_print_timings:       total time =    2157.69 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the statement is true or false:

A person who is addicted to drugs is unable to make sound decisions.

True or False?<eos> [end of text]

llama_print_timings:        load time =     158.66 ms
llama_print_timings:      sample time =       5.74 ms /    28 runs   (    0.20 ms per token,  4880.60 tokens per second)
llama_print_timings: prompt eval time =      76.01 ms /     2 tokens (   38.00 ms per token,    26.31 tokens per second)
llama_print_timings:        eval time =    1778.37 ms /    27 runs   (   65.87 ms per token,    15.18 tokens per second)
llama_print_timings:       total time =    1915.30 ms /    29 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32118.15 ms
main:    total time = 32118.15 ms
+ echo PASS
PASS
+ echo
...
<bos> Shew, the online marketplace for DIY home improvement, has partnered with The Spruce to offer an exclusive DIY guide for homeowners.

**DIY Guide: From Vision to
...
llama_print_timings:        eval time =    1579.01 ms /    31 runs   (   50.94 ms per token,    19.63 tokens per second)
llama_print_timings:       total time =    1711.63 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32181.81 ms
main:    total time = 32181.81 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar! is a book that provides practical guidance and inspiration for young people to pursue their dreams and achieve success in their lives.
...
llama_print_timings: prompt eval time =      64.66 ms /     2 tokens (   32.33 ms per token,    30.93 tokens per second)
llama_print_timings:        eval time =    1534.04 ms /    31 runs   (   49.49 ms per token,    20.21 tokens per second)
...
llama_print_timings:        load time =     576.56 ms
llama_print_timings:      sample time =       2.31 ms /    64 runs   (    0.04 ms per token, 27681.66 tokens per second)
llama_print_timings: prompt eval time =     301.97 ms /     8 tokens (   37.75 ms per token,    26.49 tokens per second)
llama_print_timings:        eval time =    7687.38 ms /    63 runs   (  122.02 ms per token,     8.20 tokens per second)
llama_print_timings:       total time =    8011.17 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     552.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4587.89 ms /   128 tokens (   35.84 ms per token,    27.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4598.64 ms /   129 tokens
...
llama_print_timings: prompt eval time =     205.72 ms /     8 tokens (   25.71 ms per token,    38.89 tokens per second)
llama_print_timings:        eval time =    5368.07 ms /    63 runs   (   85.21 ms per token,    11.74 tokens per second)
llama_print_timings:       total time =    5592.83 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     356.85 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2817.47 ms /   128 tokens (   22.01 ms per token,    45.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2827.68 ms /   129 tokens
...
llama_print_timings: prompt eval time =     206.80 ms /     8 tokens (   25.85 ms per token,    38.68 tokens per second)
llama_print_timings:        eval time =    4524.51 ms /    63 runs   (   71.82 ms per token,    13.92 tokens per second)
llama_print_timings:       total time =    4750.40 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3113.98 ms /   128 tokens (   24.33 ms per token,    41.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3124.12 ms /   129 tokens
...
llama_print_timings: prompt eval time =     371.29 ms /     8 tokens (   46.41 ms per token,    21.55 tokens per second)
llama_print_timings:        eval time =    4826.23 ms /    63 runs   (   76.61 ms per token,    13.05 tokens per second)
llama_print_timings:       total time =    5217.56 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5833.56 ms /   128 tokens (   45.57 ms per token,    21.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5844.20 ms /   129 tokens
...
llama_print_timings: prompt eval time =     392.87 ms /     8 tokens (   49.11 ms per token,    20.36 tokens per second)
llama_print_timings:        eval time =    5060.60 ms /    63 runs   (   80.33 ms per token,    12.45 tokens per second)
llama_print_timings:       total time =    5473.34 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6260.10 ms /   128 tokens (   48.91 ms per token,    20.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6270.47 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     340.03 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31204.29 tokens per second)
llama_print_timings: prompt eval time =     417.92 ms /     8 tokens (   52.24 ms per token,    19.14 tokens per second)
llama_print_timings:        eval time =    5456.79 ms /    63 runs   (   86.62 ms per token,    11.55 tokens per second)
llama_print_timings:       total time =    5894.26 ms /    71 tokens
Log end
...
[1]4.2586,
llama_print_timings:        load time =     319.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6553.52 ms /   128 tokens (   51.20 ms per token,    19.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6563.73 ms /   129 tokens
...
llama_print_timings: prompt eval time =     609.68 ms /     8 tokens (   76.21 ms per token,    13.12 tokens per second)
llama_print_timings:        eval time =    5683.38 ms /    63 runs   (   90.21 ms per token,    11.08 tokens per second)
llama_print_timings:       total time =    6312.30 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9865.46 ms /   128 tokens (   77.07 ms per token,    12.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9876.39 ms /   129 tokens
...
llama_print_timings: prompt eval time =     462.00 ms /     8 tokens (   57.75 ms per token,    17.32 tokens per second)
llama_print_timings:        eval time =    4921.94 ms /    63 runs   (   78.13 ms per token,    12.80 tokens per second)
llama_print_timings:       total time =    5403.36 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7397.56 ms /   128 tokens (   57.79 ms per token,    17.30 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7408.30 ms /   129 tokens
...
llama_print_timings:        load time =     300.80 ms
...
llama_print_timings:        eval time =    4986.74 ms /    63 runs   (   79.15 ms per token,    12.63 tokens per second)
llama_print_timings:       total time =    5396.17 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6126.95 ms /   128 tokens (   47.87 ms per token,    20.89 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6137.17 ms /   129 tokens
...
llama_print_timings:      sample time =       2.03 ms /    64 runs   (    0.03 ms per token, 31511.57 tokens per second)
llama_print_timings: prompt eval time =     468.55 ms /     8 tokens (   58.57 ms per token,    17.07 tokens per second)
llama_print_timings:        eval time =    5654.54 ms /    63 runs   (   89.75 ms per token,    11.14 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7416.83 ms /   128 tokens (   57.94 ms per token,    17.26 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7427.61 ms /   129 tokens
...
llama_print_timings: prompt eval time =     519.20 ms /     8 tokens (   64.90 ms per token,    15.41 tokens per second)
llama_print_timings:        eval time =    6317.76 ms /    63 runs   (  100.28 ms per token,     9.97 tokens per second)
llama_print_timings:       total time =    6856.51 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     362.71 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8152.15 ms /   128 tokens (   63.69 ms per token,    15.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8162.41 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog and outlasts the hungry wolf.
A.


second run: The quick brown fox jumps over the lazy dog and outlasts the hungry wolf.
A.


single seq run: The quick brown fox jumps over the lazy dog and outlasts the hungry wolf.
A.
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.951 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.60 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     554.37 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4604.40 ms /   128 tokens (   35.97 ms per token,    27.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4652.20 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 42.735 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.62 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5400.00 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4616.73 ms /   128 tokens (   36.07 ms per token,    27.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4661.18 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 46.427 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     342.88 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2819.29 ms /   128 tokens (   22.03 ms per token,    45.40 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2867.41 ms /   129 tokens
...
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3884.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2816.27 ms /   128 tokens (   22.00 ms per token,    45.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2863.56 ms /   129 tokens
...
[1]7.0336,
llama_print_timings:        load time =    4198.44 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2809.59 ms /   128 tokens (   21.95 ms per token,    45.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2856.31 ms /   129 tokens
...
0.31user 0.74system 0:01.05elapsed 100%CPU (0avgtext+0avgdata 6878108maxresident)k
0inputs+40outputs (0major+111989minor)pagefaults 0swaps
```
...
0.08user 0.74system 0:00.83elapsed 100%CPU (0avgtext+0avgdata 6877976maxresident)k
0inputs+40outputs (0major+111981minor)pagefaults 0swaps
```
