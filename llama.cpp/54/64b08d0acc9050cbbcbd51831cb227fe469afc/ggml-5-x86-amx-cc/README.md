...
- status:  SUCCESS ✅
- runtime: 5:27.69
- date:    Thu Nov  7 19:46:20 UTC 2024
...
0.00.003.896 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.003.919 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
...
0.00.003.933 I llama_model_loader: - kv   4:                         general.size_label str              = small
...
0.00.018.909 I llm_load_vocab: special tokens cache size = 5
...
0.00.021.424 I llm_load_print_meta: n_vocab          = 30522
0.00.021.424 I llm_load_print_meta: n_merges         = 0
0.00.021.425 I llm_load_print_meta: vocab_only       = 0
0.00.021.425 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.425 I llm_load_print_meta: n_embd           = 384
0.00.021.426 I llm_load_print_meta: n_layer          = 12
0.00.021.434 I llm_load_print_meta: n_head           = 12
0.00.021.435 I llm_load_print_meta: n_head_kv        = 12
0.00.021.435 I llm_load_print_meta: n_rot            = 32
0.00.021.435 I llm_load_print_meta: n_swa            = 0
0.00.021.436 I llm_load_print_meta: n_embd_head_k    = 32
...
0.00.021.443 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.443 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.443 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.444 I llm_load_print_meta: n_ff             = 1536
0.00.021.444 I llm_load_print_meta: n_expert         = 0
0.00.021.445 I llm_load_print_meta: n_expert_used    = 0
0.00.021.445 I llm_load_print_meta: causal attn      = 0
0.00.021.445 I llm_load_print_meta: pooling type     = 2
0.00.021.446 I llm_load_print_meta: rope type        = 2
0.00.021.446 I llm_load_print_meta: rope scaling     = linear
0.00.021.447 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.448 I llm_load_print_meta: freq_scale_train = 1
0.00.021.448 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.449 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.449 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.450 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.450 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.450 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.450 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.451 I llm_load_print_meta: model type       = 33M
0.00.021.452 I llm_load_print_meta: model ftype      = F16
0.00.021.453 I llm_load_print_meta: model params     = 33.21 M
0.00.021.454 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.021.454 I llm_load_print_meta: general.name     = Bge Small
0.00.021.454 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.455 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.455 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.456 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.456 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.457 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.458 I llm_load_print_meta: max token length = 21
0.00.025.460 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
0.00.025.479 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
................................................
0.00.038.124 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.139 I llama_new_context_with_model: n_ctx         = 512
0.00.038.139 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.140 I llama_new_context_with_model: n_batch       = 2048
0.00.038.140 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.140 I llama_new_context_with_model: flash_attn    = 0
0.00.038.142 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.143 I llama_new_context_with_model: freq_scale    = 1
0.00.041.203 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.230 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.237 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.515 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.043.536 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.536 I llama_new_context_with_model: graph nodes  = 429
0.00.043.537 I llama_new_context_with_model: graph splits = 145
0.00.043.538 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.047.446 I 
0.00.047.533 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.053.907 I llama_perf_context_print:        load time =      46.70 ms
0.00.053.910 I llama_perf_context_print: prompt eval time =       4.38 ms /     9 tokens (    0.49 ms per token,  2054.33 tokens per second)
0.00.053.911 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.913 I llama_perf_context_print:       total time =       6.46 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.512 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.777 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.007.686 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.686 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.687 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
...
0.00.020.799 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.824 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.825 I llm_load_print_meta: arch             = bert
0.00.020.825 I llm_load_print_meta: vocab type       = WPM
0.00.020.826 I llm_load_print_meta: n_vocab          = 30522
0.00.020.826 I llm_load_print_meta: n_merges         = 0
0.00.020.826 I llm_load_print_meta: vocab_only       = 0
0.00.020.826 I llm_load_print_meta: n_ctx_train      = 512
0.00.020.827 I llm_load_print_meta: n_embd           = 384
0.00.020.827 I llm_load_print_meta: n_layer          = 12
0.00.020.835 I llm_load_print_meta: n_head           = 12
0.00.020.836 I llm_load_print_meta: n_head_kv        = 12
0.00.020.836 I llm_load_print_meta: n_rot            = 32
0.00.020.836 I llm_load_print_meta: n_swa            = 0
0.00.020.836 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.836 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.837 I llm_load_print_meta: n_gqa            = 1
0.00.020.838 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.839 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.840 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.840 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.020.841 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.841 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.841 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.842 I llm_load_print_meta: n_ff             = 1536
0.00.020.842 I llm_load_print_meta: n_expert         = 0
0.00.020.842 I llm_load_print_meta: n_expert_used    = 0
0.00.020.843 I llm_load_print_meta: causal attn      = 0
0.00.020.844 I llm_load_print_meta: pooling type     = 2
0.00.020.844 I llm_load_print_meta: rope type        = 2
0.00.020.844 I llm_load_print_meta: rope scaling     = linear
0.00.020.846 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.846 I llm_load_print_meta: freq_scale_train = 1
0.00.020.846 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.847 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.020.848 I llm_load_print_meta: model type       = 33M
0.00.020.849 I llm_load_print_meta: model ftype      = Q8_0
...
0.00.020.865 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.865 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.865 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.865 I llm_load_print_meta: max token length = 21
0.00.023.632 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.024.877 I llama_new_context_with_model: n_seq_max     = 1
0.00.024.892 I llama_new_context_with_model: n_ctx         = 512
0.00.024.893 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.024.893 I llama_new_context_with_model: n_batch       = 2048
0.00.024.893 I llama_new_context_with_model: n_ubatch      = 2048
0.00.024.893 I llama_new_context_with_model: flash_attn    = 0
0.00.024.895 I llama_new_context_with_model: freq_base     = 10000.0
0.00.024.896 I llama_new_context_with_model: freq_scale    = 1
0.00.027.098 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.027.118 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.027.123 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.029.025 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.029.047 I llama_new_context_with_model: graph nodes  = 429
0.00.029.048 I llama_new_context_with_model: graph splits = 1
0.00.029.049 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.031.870 I 
0.00.031.945 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.033.420 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.036.355 I llama_perf_context_print:        load time =      31.17 ms
0.00.036.357 I llama_perf_context_print: prompt eval time =       2.72 ms /     9 tokens (    0.30 ms per token,  3312.48 tokens per second)
0.00.036.358 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.036.360 I llama_perf_context_print:       total time =       4.48 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.699 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.759 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.787 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
...
0.00.008.812 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.815 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.816 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.817 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.818 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.819 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.849 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.850 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.850 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.850 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.851 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.851 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.852 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.852 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.853 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.853 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.854 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.856 I llama_model_loader: - type  f32:   41 tensors
0.00.019.857 I llama_model_loader: - type  f16:   29 tensors
0.00.037.627 W llm_load_vocab: empty token at index 5
0.00.048.148 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
...
0.00.342.946 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.342.946 I llm_load_print_meta: arch             = jina-bert-v2
0.00.342.947 I llm_load_print_meta: vocab type       = BPE
0.00.342.948 I llm_load_print_meta: n_vocab          = 61056
0.00.342.948 I llm_load_print_meta: n_merges         = 39382
0.00.342.948 I llm_load_print_meta: vocab_only       = 0
0.00.342.949 I llm_load_print_meta: n_ctx_train      = 8192
0.00.342.949 I llm_load_print_meta: n_embd           = 384
0.00.342.950 I llm_load_print_meta: n_layer          = 4
0.00.342.960 I llm_load_print_meta: n_head           = 12
0.00.342.961 I llm_load_print_meta: n_head_kv        = 12
0.00.342.961 I llm_load_print_meta: n_rot            = 32
0.00.342.961 I llm_load_print_meta: n_swa            = 0
0.00.342.962 I llm_load_print_meta: n_embd_head_k    = 32
0.00.342.962 I llm_load_print_meta: n_embd_head_v    = 32
0.00.342.963 I llm_load_print_meta: n_gqa            = 1
0.00.342.964 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.342.964 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.342.966 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.342.967 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.342.967 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.342.968 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.342.968 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.342.969 I llm_load_print_meta: n_ff             = 1536
0.00.342.969 I llm_load_print_meta: n_expert         = 0
0.00.342.970 I llm_load_print_meta: n_expert_used    = 0
0.00.342.970 I llm_load_print_meta: causal attn      = 0
0.00.342.970 I llm_load_print_meta: pooling type     = -1
0.00.342.971 I llm_load_print_meta: rope type        = -1
0.00.342.971 I llm_load_print_meta: rope scaling     = linear
0.00.342.972 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.342.973 I llm_load_print_meta: freq_scale_train = 1
0.00.342.973 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.342.974 I llm_load_print_meta: rope_finetuned   = unknown
0.00.342.974 I llm_load_print_meta: ssm_d_conv       = 0
0.00.342.974 I llm_load_print_meta: ssm_d_inner      = 0
0.00.342.975 I llm_load_print_meta: ssm_d_state      = 0
0.00.342.975 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.342.975 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.342.976 I llm_load_print_meta: model type       = 33M
0.00.342.976 I llm_load_print_meta: model ftype      = F16
0.00.342.978 I llm_load_print_meta: model params     = 32.90 M
0.00.342.978 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.342.979 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.342.979 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.342.979 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.342.980 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.342.980 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.342.980 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.342.981 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.342.981 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.342.981 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.342.981 I llm_load_print_meta: max token length = 45
0.00.346.937 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
0.00.346.951 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
.....................
0.00.354.969 I llama_new_context_with_model: n_seq_max     = 1
0.00.354.990 I llama_new_context_with_model: n_ctx         = 8192
0.00.354.991 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.354.991 I llama_new_context_with_model: n_batch       = 2048
0.00.354.991 I llama_new_context_with_model: n_ubatch      = 2048
0.00.354.992 I llama_new_context_with_model: flash_attn    = 0
0.00.354.993 I llama_new_context_with_model: freq_base     = 10000.0
0.00.354.994 I llama_new_context_with_model: freq_scale    = 1
0.00.364.724 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.364.750 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.364.756 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.366.159 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.366.172 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.366.173 I llama_new_context_with_model: graph nodes  = 154
0.00.366.173 I llama_new_context_with_model: graph splits = 57
0.00.366.175 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.054 I 
0.00.375.151 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.375.401 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.375.414 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.420 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.420 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.425 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.425 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.306 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.388.449 I llama_perf_context_print:        load time =     374.17 ms
0.00.388.451 I llama_perf_context_print: prompt eval time =       8.91 ms /    62 tokens (    0.14 ms per token,  6958.47 tokens per second)
0.00.388.452 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.388.453 I llama_perf_context_print:       total time =      13.40 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.659 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.887 I main: llama backend init
0.00.001.057 I main: load the model and apply lora adapter, if any
0.00.009.786 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.076.056 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.057 I llm_load_print_meta: model params     = 1.41 B
0.00.076.058 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.189.611 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.189.627 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.977.488 I llama_new_context_with_model: n_seq_max     = 1
0.00.977.509 I llama_new_context_with_model: n_ctx         = 2048
0.00.977.509 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.977.510 I llama_new_context_with_model: n_batch       = 2048
0.00.977.510 I llama_new_context_with_model: n_ubatch      = 512
0.00.977.511 I llama_new_context_with_model: flash_attn    = 0
0.00.977.516 I llama_new_context_with_model: freq_base     = 10000.0
0.00.977.517 I llama_new_context_with_model: freq_scale    = 1
0.01.066.458 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.066.482 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.066.512 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.069.513 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.069.539 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.069.540 I llama_new_context_with_model: graph nodes  = 967
0.01.069.589 I llama_new_context_with_model: graph splits = 194
0.01.069.594 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.171.133 I main: llama threadpool init, n_threads = 4
0.01.171.159 I 
0.01.171.243 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.171.256 I 
0.01.171.403 I sampler seed: 1234
0.01.171.422 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.171.425 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.171.425 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.171.425 I 
...
0.04.990.660 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32390.51 tokens per second)
0.04.990.663 I llama_perf_context_print:        load time =    1170.04 ms
0.04.990.665 I llama_perf_context_print: prompt eval time =      96.11 ms /     7 tokens (   13.73 ms per token,    72.83 tokens per second)
0.04.990.667 I llama_perf_context_print:        eval time =    3711.68 ms /    63 runs   (   58.92 ms per token,    16.97 tokens per second)
0.04.990.668 I llama_perf_context_print:       total time =    3819.53 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.743 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.153 I llama_model_loader: - type  f16:   98 tensors
...
0.00.195.169 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.195.186 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.993.595 I llama_new_context_with_model: n_seq_max     = 1
0.00.993.618 I llama_new_context_with_model: n_ctx         = 128
0.00.993.618 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.993.618 I llama_new_context_with_model: n_batch       = 128
0.00.993.618 I llama_new_context_with_model: n_ubatch      = 128
0.00.993.619 I llama_new_context_with_model: flash_attn    = 0
0.00.993.624 I llama_new_context_with_model: freq_base     = 10000.0
0.00.993.625 I llama_new_context_with_model: freq_scale    = 1
0.00.993.626 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.999.317 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.999.347 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.999.373 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.001.882 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.01.001.906 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.01.001.907 I llama_new_context_with_model: graph nodes  = 967
0.01.001.907 I llama_new_context_with_model: graph splits = 194
0.01.001.909 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.068.997 I 
0.01.069.138 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.069.158 I perplexity: tokenizing the input ..
0.01.078.645 I perplexity: tokenization took 9.484 ms
0.01.078.678 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.998.264 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.02.001.760 I Final estimate: PPL = 10.1479 +/- 3.22609

0.02.001.867 I llama_perf_context_print:        load time =    1068.05 ms
0.02.001.869 I llama_perf_context_print: prompt eval time =     917.76 ms /   128 tokens (    7.17 ms per token,   139.47 tokens per second)
0.02.001.870 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.001.871 I llama_perf_context_print:       total time =     932.87 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.773 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.809 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
...
0.00.166.397 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.737 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.757 I llama_new_context_with_model: n_ctx         = 2048
0.00.168.757 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.168.757 I llama_new_context_with_model: n_batch       = 2048
0.00.168.758 I llama_new_context_with_model: n_ubatch      = 512
0.00.168.758 I llama_new_context_with_model: flash_attn    = 0
0.00.168.760 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.761 I llama_new_context_with_model: freq_scale    = 1
0.00.237.435 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.237.458 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.237.475 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.466 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.488 I llama_new_context_with_model: graph nodes  = 967
0.00.239.488 I llama_new_context_with_model: graph splits = 1
0.00.239.492 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.338.507 I main: llama threadpool init, n_threads = 4
0.00.338.534 I 
0.00.338.603 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.338.615 I 
0.00.338.719 I sampler seed: 1234
0.00.338.737 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.338.740 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.338.741 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.338.741 I 
...
0.03.114.885 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31981.98 tokens per second)
0.03.114.889 I llama_perf_context_print:        load time =     337.34 ms
0.03.114.890 I llama_perf_context_print: prompt eval time =     123.99 ms /     7 tokens (   17.71 ms per token,    56.46 tokens per second)
0.03.114.891 I llama_perf_context_print:        eval time =    2640.70 ms /    63 runs   (   41.92 ms per token,    23.86 tokens per second)
0.03.114.892 I llama_perf_context_print:       total time =    2776.38 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.693 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.303 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.166.099 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.254 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.277 I llama_new_context_with_model: n_ctx         = 128
0.00.168.277 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.168.277 I llama_new_context_with_model: n_batch       = 128
0.00.168.278 I llama_new_context_with_model: n_ubatch      = 128
0.00.168.278 I llama_new_context_with_model: flash_attn    = 0
0.00.168.280 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.280 I llama_new_context_with_model: freq_scale    = 1
0.00.168.281 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.173.434 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.173.457 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
...
0.00.175.958 I llama_new_context_with_model: graph nodes  = 967
0.00.175.958 I llama_new_context_with_model: graph splits = 1
0.00.175.960 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.241.551 I 
0.00.241.659 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.241.679 I perplexity: tokenizing the input ..
0.00.250.292 I perplexity: tokenization took 8.61 ms
0.00.250.325 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.155.068 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.159.083 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.159.127 I llama_perf_context_print:        load time =     240.61 ms
0.01.159.129 I llama_perf_context_print: prompt eval time =     903.25 ms /   128 tokens (    7.06 ms per token,   141.71 tokens per second)
0.01.159.130 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.159.131 I llama_perf_context_print:       total time =     917.58 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.690 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.537 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.190 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.125.206 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.370.271 I llama_new_context_with_model: n_seq_max     = 1
0.00.370.293 I llama_new_context_with_model: n_ctx         = 2048
0.00.370.293 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.370.293 I llama_new_context_with_model: n_batch       = 2048
0.00.370.294 I llama_new_context_with_model: n_ubatch      = 512
0.00.370.294 I llama_new_context_with_model: flash_attn    = 0
0.00.370.298 I llama_new_context_with_model: freq_base     = 10000.0
0.00.370.300 I llama_new_context_with_model: freq_scale    = 1
0.00.439.453 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.439.481 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.439.511 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.442.532 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.442.556 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.442.556 I llama_new_context_with_model: graph nodes  = 967
0.00.442.556 I llama_new_context_with_model: graph splits = 193
0.00.442.561 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.513.828 I main: llama threadpool init, n_threads = 4
0.00.513.855 I 
0.00.513.948 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.513.948 I 
0.00.514.089 I sampler seed: 1234
0.00.514.110 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.514.113 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.514.113 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.514.113 I 
...
0.01.913.647 I llama_perf_sampler_print:    sampling time =       2.20 ms /    71 runs   (    0.03 ms per token, 32287.40 tokens per second)
0.01.913.650 I llama_perf_context_print:        load time =     512.72 ms
0.01.913.651 I llama_perf_context_print: prompt eval time =      39.23 ms /     7 tokens (    5.60 ms per token,   178.44 tokens per second)
0.01.913.653 I llama_perf_context_print:        eval time =    1349.23 ms /    63 runs   (   21.42 ms per token,    46.69 tokens per second)
0.01.913.653 I llama_perf_context_print:       total time =    1399.83 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.657 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.864 I llm_load_print_meta: model ftype      = Q4_0
0.00.074.864 I llm_load_print_meta: model params     = 1.41 B
0.00.074.865 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.124.501 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.124.517 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.369.285 I llama_new_context_with_model: n_seq_max     = 1
0.00.369.306 I llama_new_context_with_model: n_ctx         = 128
0.00.369.306 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.369.306 I llama_new_context_with_model: n_batch       = 128
0.00.369.307 I llama_new_context_with_model: n_ubatch      = 128
0.00.369.307 I llama_new_context_with_model: flash_attn    = 0
0.00.369.311 I llama_new_context_with_model: freq_base     = 10000.0
0.00.369.313 I llama_new_context_with_model: freq_scale    = 1
0.00.369.313 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.375.175 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.375.204 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.375.228 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.378.316 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.378.341 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.378.341 I llama_new_context_with_model: graph nodes  = 967
0.00.378.342 I llama_new_context_with_model: graph splits = 193
0.00.378.344 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.415.928 I 
0.00.416.056 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.416.090 I perplexity: tokenizing the input ..
0.00.425.580 I perplexity: tokenization took 9.485 ms
0.00.425.616 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.882.251 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.886.094 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.886.194 I llama_perf_context_print:        load time =     415.08 ms
0.00.886.197 I llama_perf_context_print: prompt eval time =     454.79 ms /   128 tokens (    3.55 ms per token,   281.45 tokens per second)
0.00.886.198 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.886.199 I llama_perf_context_print:       total time =     470.27 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.654 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.210 I llm_load_print_meta: model ftype      = Q4_1
...
0.00.119.487 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.119.505 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.389.449 I llama_new_context_with_model: n_seq_max     = 1
0.00.389.470 I llama_new_context_with_model: n_ctx         = 2048
0.00.389.471 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.389.471 I llama_new_context_with_model: n_batch       = 2048
0.00.389.471 I llama_new_context_with_model: n_ubatch      = 512
0.00.389.472 I llama_new_context_with_model: flash_attn    = 0
0.00.389.476 I llama_new_context_with_model: freq_base     = 10000.0
0.00.389.477 I llama_new_context_with_model: freq_scale    = 1
0.00.459.381 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.459.412 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.459.445 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.462.523 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.462.547 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.462.547 I llama_new_context_with_model: graph nodes  = 967
0.00.462.548 I llama_new_context_with_model: graph splits = 193
0.00.462.552 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.531.481 I main: llama threadpool init, n_threads = 4
0.00.531.508 I 
0.00.531.602 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.531.602 I 
0.00.531.742 I sampler seed: 1234
0.00.531.762 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.531.765 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.531.766 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.531.766 I 
...
0.02.041.239 I llama_perf_sampler_print:    sampling time =       2.13 ms /    71 runs   (    0.03 ms per token, 33270.85 tokens per second)
0.02.041.241 I llama_perf_context_print:        load time =     530.33 ms
0.02.041.243 I llama_perf_context_print: prompt eval time =      39.08 ms /     7 tokens (    5.58 ms per token,   179.13 tokens per second)
0.02.041.244 I llama_perf_context_print:        eval time =    1459.30 ms /    63 runs   (   23.16 ms per token,    43.17 tokens per second)
0.02.041.244 I llama_perf_context_print:       total time =    1509.76 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.717 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.146 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.021.149 I llama_model_loader: - type  f32:  194 tensors
0.00.021.150 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.075.965 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.966 I llm_load_print_meta: model params     = 1.41 B
0.00.075.967 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.121.016 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.121.032 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.393.588 I llama_new_context_with_model: n_seq_max     = 1
0.00.393.610 I llama_new_context_with_model: n_ctx         = 128
0.00.393.610 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.393.611 I llama_new_context_with_model: n_batch       = 128
0.00.393.611 I llama_new_context_with_model: n_ubatch      = 128
0.00.393.612 I llama_new_context_with_model: flash_attn    = 0
0.00.393.616 I llama_new_context_with_model: freq_base     = 10000.0
0.00.393.618 I llama_new_context_with_model: freq_scale    = 1
0.00.393.618 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.399.418 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.399.442 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.399.466 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.402.436 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.402.460 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.402.460 I llama_new_context_with_model: graph nodes  = 967
0.00.402.460 I llama_new_context_with_model: graph splits = 193
0.00.402.462 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.434.568 I 
0.00.434.695 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.434.728 I perplexity: tokenizing the input ..
0.00.444.488 I perplexity: tokenization took 9.756 ms
0.00.444.522 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.914.152 I perplexity: 0.47 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.917.975 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.918.074 I llama_perf_context_print:        load time =     433.67 ms
0.00.918.076 I llama_perf_context_print: prompt eval time =     467.82 ms /   128 tokens (    3.65 ms per token,   273.61 tokens per second)
0.00.918.078 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.918.079 I llama_perf_context_print:       total time =     483.51 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.664 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.439 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
...
0.00.120.983 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.123.193 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.215 I llama_new_context_with_model: n_ctx         = 2048
0.00.123.215 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.123.216 I llama_new_context_with_model: n_batch       = 2048
0.00.123.216 I llama_new_context_with_model: n_ubatch      = 512
0.00.123.216 I llama_new_context_with_model: flash_attn    = 0
0.00.123.218 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.219 I llama_new_context_with_model: freq_scale    = 1
0.00.191.892 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.191.921 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.191.942 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.193.937 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.193.958 I llama_new_context_with_model: graph nodes  = 967
0.00.193.958 I llama_new_context_with_model: graph splits = 1
0.00.193.962 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.271.065 I main: llama threadpool init, n_threads = 4
0.00.271.093 I 
0.00.271.173 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.271.174 I 
0.00.271.279 I sampler seed: 1234
0.00.271.299 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.271.302 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.271.302 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.271.302 I 
...
0.02.547.065 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32449.73 tokens per second)
0.02.547.069 I llama_perf_context_print:        load time =     269.98 ms
0.02.547.070 I llama_perf_context_print: prompt eval time =     123.78 ms /     7 tokens (   17.68 ms per token,    56.55 tokens per second)
0.02.547.072 I llama_perf_context_print:        eval time =    2140.37 ms /    63 runs   (   33.97 ms per token,    29.43 tokens per second)
0.02.547.073 I llama_perf_context_print:       total time =    2276.00 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.688 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.003 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.021.006 I llama_model_loader: - type  f32:  194 tensors
0.00.021.007 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.075.924 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.925 I llm_load_print_meta: model params     = 1.41 B
0.00.075.926 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.122.432 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.133.593 I llama_new_context_with_model: n_seq_max     = 1
0.00.133.614 I llama_new_context_with_model: n_ctx         = 128
0.00.133.614 I llama_new_context_with_model: n_ctx_per_seq = 128
...
0.00.139.084 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.139.111 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.139.127 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.141.154 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.141.170 I llama_new_context_with_model: graph nodes  = 967
0.00.141.170 I llama_new_context_with_model: graph splits = 1
0.00.141.172 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.213.736 I 
0.00.213.832 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.213.841 I perplexity: tokenizing the input ..
0.00.222.317 I perplexity: tokenization took 8.473 ms
0.00.222.348 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.372.451 I perplexity: 1.15 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.376.068 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.376.107 I llama_perf_context_print:        load time =     212.88 ms
0.01.376.109 I llama_perf_context_print: prompt eval time =    1148.46 ms /   128 tokens (    8.97 ms per token,   111.45 tokens per second)
0.01.376.111 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.376.112 I llama_perf_context_print:       total time =    1162.37 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.678 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.510 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.510 I llm_load_print_meta: model params     = 1.41 B
0.00.075.511 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.690 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.888 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.910 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.910 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.910 I llama_new_context_with_model: n_batch       = 2048
0.00.126.911 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.911 I llama_new_context_with_model: flash_attn    = 0
0.00.126.913 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.914 I llama_new_context_with_model: freq_scale    = 1
0.00.195.523 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.551 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.568 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.198.081 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.198.102 I llama_new_context_with_model: graph nodes  = 967
0.00.198.102 I llama_new_context_with_model: graph splits = 1
0.00.198.106 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.990 I main: llama threadpool init, n_threads = 4
0.00.291.019 I 
0.00.291.103 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.291.115 I 
0.00.291.223 I sampler seed: 1234
0.00.291.243 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.291.246 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.291.246 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.291.247 I 
...
0.02.674.602 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 30936.82 tokens per second)
0.02.674.605 I llama_perf_context_print:        load time =     289.89 ms
0.02.674.607 I llama_perf_context_print: prompt eval time =     120.16 ms /     7 tokens (   17.17 ms per token,    58.26 tokens per second)
0.02.674.609 I llama_perf_context_print:        eval time =    2251.77 ms /    63 runs   (   35.74 ms per token,    27.98 tokens per second)
0.02.674.609 I llama_perf_context_print:       total time =    2383.62 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.707 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.564 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.125.353 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.127.478 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.500 I llama_new_context_with_model: n_ctx         = 128
0.00.127.501 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.501 I llama_new_context_with_model: n_batch       = 128
0.00.127.501 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.502 I llama_new_context_with_model: flash_attn    = 0
0.00.127.503 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.504 I llama_new_context_with_model: freq_scale    = 1
0.00.127.505 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.133.115 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.133.136 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.133.150 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.135.172 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.135.194 I llama_new_context_with_model: graph nodes  = 967
0.00.135.194 I llama_new_context_with_model: graph splits = 1
0.00.135.196 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.692 I 
0.00.193.798 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.804 I perplexity: tokenizing the input ..
0.00.202.602 I perplexity: tokenization took 8.794 ms
0.00.202.635 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.142.208 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.146.074 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.146.115 I llama_perf_context_print:        load time =     192.80 ms
0.02.146.117 I llama_perf_context_print: prompt eval time =    1937.85 ms /   128 tokens (   15.14 ms per token,    66.05 tokens per second)
0.02.146.118 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.146.118 I llama_perf_context_print:       total time =    1952.42 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.672 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.970 I llm_load_print_meta: max token length = 1024
0.00.105.160 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.107.376 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.397 I llama_new_context_with_model: n_ctx         = 2048
0.00.107.397 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.107.398 I llama_new_context_with_model: n_batch       = 2048
...
0.00.176.578 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.176.607 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.176.624 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.179.196 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.254.543 I main: llama threadpool init, n_threads = 4
0.00.254.571 I 
0.00.254.656 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.254.656 I 
0.00.254.773 I sampler seed: 1234
0.00.254.794 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.254.796 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.254.797 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.254.797 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.721.184 I llama_perf_sampler_print:    sampling time =       2.13 ms /    71 runs   (    0.03 ms per token, 33348.99 tokens per second)
0.01.721.187 I llama_perf_context_print:        load time =     253.41 ms
0.01.721.189 I llama_perf_context_print: prompt eval time =      82.26 ms /     7 tokens (   11.75 ms per token,    85.10 tokens per second)
0.01.721.190 I llama_perf_context_print:        eval time =    1373.53 ms /    63 runs   (   21.80 ms per token,    45.87 tokens per second)
0.01.721.191 I llama_perf_context_print:       total time =    1466.65 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.784 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.793 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.105.704 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.107.965 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.987 I llama_new_context_with_model: n_ctx         = 128
0.00.107.987 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.107.987 I llama_new_context_with_model: n_batch       = 128
0.00.107.988 I llama_new_context_with_model: n_ubatch      = 128
0.00.107.988 I llama_new_context_with_model: flash_attn    = 0
0.00.107.990 I llama_new_context_with_model: freq_base     = 10000.0
0.00.107.991 I llama_new_context_with_model: freq_scale    = 1
0.00.107.991 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.113.721 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.113.749 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.113.764 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.115.791 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.115.813 I llama_new_context_with_model: graph nodes  = 967
0.00.115.814 I llama_new_context_with_model: graph splits = 1
0.00.115.816 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.152.548 I 
0.00.152.649 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.152.668 I perplexity: tokenizing the input ..
0.00.161.451 I perplexity: tokenization took 8.778 ms
0.00.161.483 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.456.260 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.460.008 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.460.053 I llama_perf_context_print:        load time =     151.58 ms
0.01.460.055 I llama_perf_context_print: prompt eval time =    1292.95 ms /   128 tokens (   10.10 ms per token,    99.00 tokens per second)
0.01.460.057 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.460.058 I llama_perf_context_print:       total time =    1307.51 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.689 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.835 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.113.642 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.115.820 I llama_new_context_with_model: n_seq_max     = 1
0.00.115.842 I llama_new_context_with_model: n_ctx         = 2048
0.00.115.843 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.115.843 I llama_new_context_with_model: n_batch       = 2048
0.00.115.843 I llama_new_context_with_model: n_ubatch      = 512
0.00.115.844 I llama_new_context_with_model: flash_attn    = 0
0.00.115.846 I llama_new_context_with_model: freq_base     = 10000.0
0.00.115.847 I llama_new_context_with_model: freq_scale    = 1
0.00.185.266 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.185.296 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.185.313 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.187.446 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.187.465 I llama_new_context_with_model: graph nodes  = 967
0.00.187.465 I llama_new_context_with_model: graph splits = 1
0.00.187.468 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.270.565 I main: llama threadpool init, n_threads = 4
0.00.270.594 I 
0.00.270.684 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.270.698 I 
0.00.270.851 I sampler seed: 1234
...
0.02.024.212 I llama_perf_sampler_print:    sampling time =       2.16 ms /    71 runs   (    0.03 ms per token, 32916.09 tokens per second)
0.02.024.216 I llama_perf_context_print:        load time =     269.40 ms
0.02.024.217 I llama_perf_context_print: prompt eval time =      89.27 ms /     7 tokens (   12.75 ms per token,    78.41 tokens per second)
0.02.024.218 I llama_perf_context_print:        eval time =    1653.21 ms /    63 runs   (   26.24 ms per token,    38.11 tokens per second)
0.02.024.219 I llama_perf_context_print:       total time =    1753.66 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.677 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.533 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.020.536 I llama_model_loader: - type  f32:  194 tensors
0.00.020.536 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.536 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.537 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.074.123 I llm_load_print_meta: format           = GGUF V3 (latest)
...
0.00.074.126 I llm_load_print_meta: n_embd           = 2048
0.00.074.126 I llm_load_print_meta: n_layer          = 24
0.00.074.135 I llm_load_print_meta: n_head           = 16
0.00.074.136 I llm_load_print_meta: n_head_kv        = 16
...
0.00.074.151 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.152 I llm_load_print_meta: model params     = 1.41 B
0.00.074.153 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.074.155 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.155 I llm_load_print_meta: max token length = 1024
0.00.111.351 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.113.455 I llama_new_context_with_model: n_seq_max     = 1
0.00.113.477 I llama_new_context_with_model: n_ctx         = 128
0.00.113.478 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.113.478 I llama_new_context_with_model: n_batch       = 128
0.00.113.478 I llama_new_context_with_model: n_ubatch      = 128
0.00.113.479 I llama_new_context_with_model: flash_attn    = 0
0.00.113.480 I llama_new_context_with_model: freq_base     = 10000.0
0.00.113.481 I llama_new_context_with_model: freq_scale    = 1
0.00.113.482 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.118.863 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.118.885 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.118.898 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.120.865 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.120.887 I llama_new_context_with_model: graph nodes  = 967
0.00.120.887 I llama_new_context_with_model: graph splits = 1
0.00.120.889 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.167.855 I 
0.00.167.958 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.167.989 I perplexity: tokenizing the input ..
0.00.176.723 I perplexity: tokenization took 8.754 ms
0.00.176.755 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.515.958 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.519.905 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.519.944 I llama_perf_context_print:        load time =     167.00 ms
0.01.519.946 I llama_perf_context_print: prompt eval time =    1337.38 ms /   128 tokens (   10.45 ms per token,    95.71 tokens per second)
0.01.519.947 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.519.948 I llama_perf_context_print:       total time =    1352.09 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.679 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.926 I main: llama backend init
0.00.001.153 I main: load the model and apply lora adapter, if any
0.00.009.846 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf (version GGUF V3 (latest))
...
0.00.021.539 I llama_model_loader: - type q4_K:   61 tensors
0.00.021.540 I llama_model_loader: - type q5_K:   24 tensors
0.00.021.540 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.120.560 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.123.013 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.036 I llama_new_context_with_model: n_ctx         = 2048
0.00.123.036 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.123.037 I llama_new_context_with_model: n_batch       = 2048
0.00.123.037 I llama_new_context_with_model: n_ubatch      = 512
0.00.123.037 I llama_new_context_with_model: flash_attn    = 0
0.00.123.039 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.040 I llama_new_context_with_model: freq_scale    = 1
0.00.193.168 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.193.190 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.193.211 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.195.320 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.195.343 I llama_new_context_with_model: graph nodes  = 967
0.00.195.343 I llama_new_context_with_model: graph splits = 1
0.00.195.348 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.278.893 I main: llama threadpool init, n_threads = 4
0.00.278.922 I 
0.00.279.008 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.279.022 I 
0.00.279.158 I sampler seed: 1234
0.00.279.189 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.279.192 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.279.193 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.279.193 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.277.423 I llama_perf_sampler_print:    sampling time =       2.20 ms /    71 runs   (    0.03 ms per token, 32243.42 tokens per second)
0.02.277.426 I llama_perf_context_print:        load time =     277.69 ms
0.02.277.428 I llama_perf_context_print: prompt eval time =      93.06 ms /     7 tokens (   13.29 ms per token,    75.22 tokens per second)
0.02.277.429 I llama_perf_context_print:        eval time =    1894.15 ms /    63 runs   (   30.07 ms per token,    33.26 tokens per second)
0.02.277.429 I llama_perf_context_print:       total time =    1998.54 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.809 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.969 I llm_load_print_meta: n_embd_head_v    = 128
0.00.074.970 I llm_load_print_meta: n_gqa            = 1
0.00.074.971 I llm_load_print_meta: n_embd_k_gqa     = 2048
...
0.00.074.995 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.074.996 I llm_load_print_meta: model params     = 1.41 B
0.00.074.997 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.118.989 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.121.165 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.186 I llama_new_context_with_model: n_ctx         = 128
0.00.121.186 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.121.186 I llama_new_context_with_model: n_batch       = 128
0.00.121.187 I llama_new_context_with_model: n_ubatch      = 128
0.00.121.187 I llama_new_context_with_model: flash_attn    = 0
0.00.121.189 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.189 I llama_new_context_with_model: freq_scale    = 1
0.00.121.190 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.126.577 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.126.603 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.126.618 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.129.169 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.129.187 I llama_new_context_with_model: graph nodes  = 967
0.00.129.188 I llama_new_context_with_model: graph splits = 1
0.00.129.189 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.175.068 I 
0.00.175.171 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.175.178 I perplexity: tokenizing the input ..
0.00.183.942 I perplexity: tokenization took 8.76 ms
0.00.183.977 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.581.917 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.585.542 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.585.584 I llama_perf_context_print:        load time =     174.08 ms
0.01.585.586 I llama_perf_context_print: prompt eval time =    1396.13 ms /   128 tokens (   10.91 ms per token,    91.68 tokens per second)
0.01.585.588 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.585.588 I llama_perf_context_print:       total time =    1410.51 ms /   129 tokens
...
0.00.075.341 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.125.319 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.127.498 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.521 I llama_new_context_with_model: n_ctx         = 2048
0.00.127.521 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.127.524 I llama_new_context_with_model: freq_scale    = 1
0.00.197.742 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.197.770 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.197.792 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.200.393 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.200.416 I llama_new_context_with_model: graph nodes  = 967
0.00.200.416 I llama_new_context_with_model: graph splits = 1
0.00.200.420 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.292.382 I main: llama threadpool init, n_threads = 4
0.00.292.411 I 
0.00.292.500 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.292.514 I 
0.00.292.662 I sampler seed: 1234
0.00.292.693 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.292.696 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.292.697 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.292.697 I 
...
0.02.579.188 I llama_perf_sampler_print:    sampling time =       2.17 ms /    71 runs   (    0.03 ms per token, 32658.69 tokens per second)
0.02.579.191 I llama_perf_context_print:        load time =     291.24 ms
0.02.579.192 I llama_perf_context_print: prompt eval time =     114.10 ms /     7 tokens (   16.30 ms per token,    61.35 tokens per second)
0.02.579.193 I llama_perf_context_print:        eval time =    2161.31 ms /    63 runs   (   34.31 ms per token,    29.15 tokens per second)
0.02.579.194 I llama_perf_context_print:       total time =    2286.81 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.835 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.509 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.127.886 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.907 I llama_new_context_with_model: n_ctx         = 128
0.00.127.907 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.908 I llama_new_context_with_model: n_batch       = 128
0.00.127.908 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.908 I llama_new_context_with_model: flash_attn    = 0
0.00.127.910 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.911 I llama_new_context_with_model: freq_scale    = 1
0.00.127.911 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.133.418 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.133.442 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.133.459 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.135.897 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.135.920 I llama_new_context_with_model: graph nodes  = 967
0.00.135.920 I llama_new_context_with_model: graph splits = 1
0.00.135.922 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.441 I 
0.00.193.569 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.590 I perplexity: tokenizing the input ..
0.00.202.814 I perplexity: tokenization took 9.22 ms
0.00.202.852 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.894.277 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.898.019 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.898.065 I llama_perf_context_print:        load time =     192.42 ms
0.01.898.068 I llama_perf_context_print: prompt eval time =    1689.51 ms /   128 tokens (   13.20 ms per token,    75.76 tokens per second)
0.01.898.069 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.898.070 I llama_perf_context_print:       total time =    1704.62 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.662 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.591 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.592 I llm_load_print_meta: model params     = 1.41 B
0.00.075.593 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.127.012 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.129.157 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.179 I llama_new_context_with_model: n_ctx         = 2048
0.00.129.180 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.129.180 I llama_new_context_with_model: n_batch       = 2048
0.00.129.180 I llama_new_context_with_model: n_ubatch      = 512
0.00.129.181 I llama_new_context_with_model: flash_attn    = 0
0.00.129.183 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.184 I llama_new_context_with_model: freq_scale    = 1
0.00.199.040 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.199.069 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.199.088 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.201.161 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.201.184 I llama_new_context_with_model: graph nodes  = 967
0.00.201.184 I llama_new_context_with_model: graph splits = 1
0.00.201.188 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.289.578 I main: llama threadpool init, n_threads = 4
0.00.289.608 I 
0.00.289.698 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.289.713 I 
0.00.289.905 I sampler seed: 1234
0.00.289.926 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.289.929 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.289.929 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.289.929 I 
...
0.02.682.540 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 32010.82 tokens per second)
0.02.682.544 I llama_perf_context_print:        load time =     288.52 ms
0.02.682.545 I llama_perf_context_print: prompt eval time =     110.45 ms /     7 tokens (   15.78 ms per token,    63.38 tokens per second)
0.02.682.546 I llama_perf_context_print:        eval time =    2271.15 ms /    63 runs   (   36.05 ms per token,    27.74 tokens per second)
0.02.682.547 I llama_perf_context_print:       total time =    2392.97 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.943 I build: 4048 (5464b08d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.572 I llm_load_print_meta: n_rot            = 32
...
0.00.074.586 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.125.074 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.127.141 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.163 I llama_new_context_with_model: n_ctx         = 128
0.00.127.163 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.164 I llama_new_context_with_model: n_batch       = 128
0.00.127.164 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.164 I llama_new_context_with_model: flash_attn    = 0
0.00.127.166 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.167 I llama_new_context_with_model: freq_scale    = 1
0.00.127.167 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.133.128 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.133.154 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.133.168 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.135.243 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.135.265 I llama_new_context_with_model: graph nodes  = 967
0.00.135.265 I llama_new_context_with_model: graph splits = 1
0.00.135.267 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.327 I 
0.00.193.445 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.454 I perplexity: tokenizing the input ..
0.00.202.233 I perplexity: tokenization took 8.776 ms
0.00.202.267 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.851.775 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.855.682 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.855.723 I llama_perf_context_print:        load time =     192.20 ms
0.01.855.725 I llama_perf_context_print: prompt eval time =    1647.70 ms /   128 tokens (   12.87 ms per token,    77.68 tokens per second)
0.01.855.727 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.855.728 I llama_perf_context_print:       total time =    1662.40 ms /   129 tokens
...
0.00.446.086 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.437.194 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.43user 0.65system 0:01.09elapsed 100%CPU (0avgtext+0avgdata 5355248maxresident)k
