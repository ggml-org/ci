...
- status:  SUCCESS ✅
- runtime: 459.03
- date:    Tue Jun  4 21:28:29 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  111.83 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 175.65 sec*proc (22 tests)

Total Test time (real) = 175.66 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.14 ms /     9 tokens (    1.13 ms per token,   887.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
